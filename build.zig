...
pub fn build(b: *std.Build) void {
    ...
    const exe = if (is_legacy)
        b.addExecutable(.{
            .name = "vibeec",
            .root_source_file = b.path("src/vibeec/compiler.zig"),
            .target = target,
            .optimize = optimize,
        })
    else
    ...
    const test_modules = [_][]const u8{
        "src/vibeec/parser_v3.zig",
        "src/vibeec/codegen_v4.zig",
        "src/vibeec/type_checker.zig",
        "src/vibeec/error_reporter.zig",
        "src/vibeec/cli.zig",
        "src/vibeec/compiler.zig",
        "src/vibeec/ast.zig",
        "src/vibeec/semantic.zig",
        "src/vibeec/bytecode.zig",
        "src/vibeec/optimizer.zig",
    };
