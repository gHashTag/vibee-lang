...
export { default as ScientificFoundationSection } from './ScientificFoundationSection'
...
export { default as InvestorProofSection } from './InvestorProofSection'
export { default as MiningSolutionSection } from './MiningSolutionSection'
