// ═══════════════════════════════════════════════════════════════════════════════
// igla_competitor_gemini v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const GeminiBenchmark = struct {
...
/// 
pub const GeminiCapabilities = struct {
    coding: f64,
    reasoning: f64,
    multimodal: f64,
    context_length: i64,
...
/// 
pub const GeminiComparison = struct {
    humaneval: f64,
    natural2code: f64,
    math: f64,
    mmlu: f64,
