// ═══════════════════════════════════════════════════════════════════════════════
// counterfactual_v11900 v11900 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CFExplanation = struct {
    counterfactuals: []const u8,
    feature_changes: []const u8,
    validity_rate: f64,
    diversity_score: f64,
};
