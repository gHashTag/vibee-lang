// ═══════════════════════════════════════════════════════════════════════════════
// screen_delta_v12860 v12860.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DeltaMetrics = struct {
    compression_ratio: f64,
    avg_changed_percent: f64,
    frames_processed: i64,
};

/// 
pub const DeltaBuffer = struct {
    previous_frame: []const u8,
