// ═══════════════════════════════════════════════════════════════════════════════
// igla_v5_jamba v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const JambaLayer = struct {
    layer_type: []const u8,
    mamba_block: []const u8,
    attention_block: []const u8,
};

/// 
pub const JambaState = struct {
    mamba_state: []const u8,
    kv_cache: []const u8,
    hybrid_output: []const u8,
};
