// ═══════════════════════════════════════════════════════════════════════════════
// agent_navigation_scroll v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ScrollResult = struct {
    ...
    visible_content: []const u8,
    reached_end: bool,
};

/// 
pub const HoverTarget = struct {
    selector: []const u8,
    duration_ms: i64,
    expect_tooltip: bool,
};
