// ═══════════════════════════════════════════════════════════════════════════════
// cache_eviction_v574 v574.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const EvictionDecision = struct {
...
/// 
pub const EvictionMetrics = struct {
    evictions: i64,
    writebacks: i64,
    phi_accuracy: f64,
    reuse_distance_avg: f64,
};
