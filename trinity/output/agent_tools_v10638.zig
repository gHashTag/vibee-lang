// ═══════════════════════════════════════════════════════════════════════════════
// agent_tools_v10638 v10638.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ToolComposition = struct {
    composition_id: []const u8,
    tools: []const u8,
    flow: []const u8,
...
/// 
pub const ToolValidation = struct {
    tool_id: []const u8,
    valid: bool,
    errors: []const u8,
    warnings: []const u8,
