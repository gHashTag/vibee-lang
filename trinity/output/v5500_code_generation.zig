// ═══════════════════════════════════════════════════════════════════════════════
// code_generation v5.5.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const MAX_TOKENS: f64 = 8192;

pub const NUM_LANGUAGES: f64 = 50;
...
/// 
pub const InfillRequest = struct {
    prefix: []const u8,
    suffix: []const u8,
    max_tokens: i64,
};
...
/// 
pub const MultiFileContext = struct {
    files: []const u8,
