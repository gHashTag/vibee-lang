// ═══════════════════════════════════════════════════════════════════════════════
// voice_whisper v13509 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const WhisperSegment = struct {
    id: i64,
    start: f64,
    end: f64,
    text: []const u8,
...
/// 
pub const WhisperMetrics = struct {
    transcriptions: i64,
