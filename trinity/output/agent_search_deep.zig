// ═══════════════════════════════════════════════════════════════════════════════
// agent_search_deep v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DeepSearchQuery = struct {
    query: []const u8,
    sources: []const u8,
    depth: i64,
    max_pages_per_source: i64,
};

/// 
pub const DeepSearchSource = struct {
    name: []const u8,
    url: []const u8,
    reliability: f64,
...
/// 
pub const DeepSearchResult = struct {
    query: []const u8,
