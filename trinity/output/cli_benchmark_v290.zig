// ═══════════════════════════════════════════════════════════════════════════════
// cli_benchmark v2.9.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"case": {...}}', expected='{"result": {...}}'
}
...
// Test case: input='{"baseline": {...}, "candidate": {...}}', expected='{"speedup": 1.5}'
}
...
// When: Plotting
// Then: Generate chart
// Test case: input='{"results": [...]}', expected='{"chart": "..."}'
}
...
// Test case: input='{"history": [...]}', expected='{"regression": false}'
}
