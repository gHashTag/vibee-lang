// ═══════════════════════════════════════════════════════════════════════════════
// federated_learning_v11820 v11820 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const FLConfig = struct {
    ...
    num_rounds: i64,
    clients_per_round: i64,
    local_epochs: i64,
    privacy_budget: f64,
};

/// 
pub const FLAlgorithm = struct {
};

/// 
pub const ClientUpdate = struct {
    client_id: []const u8,
    model_delta: []const u8,
    num_samples: i64,
    local_loss: f64,
};
