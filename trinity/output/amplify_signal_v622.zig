// ═══════════════════════════════════════════════════════════════════════════════
// amplify_signal_v622 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AmplifierConfig = struct {
    gain: f64,
    bandwidth: f64,
    noise_figure: f64,
...
pub const AmplifiedSignal = struct {
    original_amplitude: f64,
    amplified_amplitude: f64,
    gain_achieved: f64,
    snr_improvement: f64,
};

/// 
pub const AmplifierMetrics = struct {
