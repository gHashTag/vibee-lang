// ═══════════════════════════════════════════════════════════════════════════════
// igla_koshey_transfer_learn v7.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const TransferState = struct {
    ...
    target_task: []const u8,
    transferred_layers: []const u8,
    adaptation_progress: f64,
};

/// 
pub const AdapterModule = struct {
    adapter_id: []const u8,
    down_proj: i64,
    up_proj: i64,
    activation: []const u8,
