// ═══════════════════════════════════════════════════════════════════════════════
// cdp_storage_handler_v12357 v12357.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const IndexedDBInfo = struct {
...
/// 
pub const CacheStorageInfo = struct {
    cache_name: []const u8,
    entries_count: i64,
    size_bytes: i64,
};
