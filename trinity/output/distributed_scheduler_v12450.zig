// ═══════════════════════════════════════════════════════════════════════════════
// distributed_scheduler_v12450 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const SchedulingPolicy = struct {
    round_robin: []const u8,
    least_loaded: []const u8,
    priority_based: []const u8,
    locality_aware: []const u8,
};
