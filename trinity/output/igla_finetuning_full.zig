// ═══════════════════════════════════════════════════════════════════════════════
// igla_finetuning_full v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FullFinetuneConfig = struct {
    learning_rate: f64,
    epochs: i64,
    warmup_ratio: f64,
    weight_decay: f64,
...
/// 
pub const FinetuneDataset = struct {
    train_samples: i64,
    val_samples: i64,
    format: []const u8,
    max_length: i64,
...
/// 
pub const FinetuneState = struct {
    current_epoch: i64,
    global_step: i64,
    best_loss: f64,
    early_stop: bool,
...
/// 
pub const FinetuneMetrics = struct {
    train_loss: f64,
    val_loss: f64,
    perplexity: f64,
    task_accuracy: f64,
