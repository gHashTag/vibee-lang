// ═══════════════════════════════════════════════════════════════════════════════
// sparse_texture_v2671 v2671.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SparseTexture = struct {
    texture_id: []const u8,
    virtual_width: i64,
    virtual_height: i64,
    tile_size: i64,
...
/// 
pub const ResidencyInfo = struct {
    total_tiles: i64,
    resident_tiles: i64,
    pending_loads: i64,
    memory_mb: f64,
...
pub const StreamingConfig = struct {
    max_resident_mb: i64,
    load_priority: []const u8,
    mip_bias: f64,
};

/// 
pub const TileRequest = struct {
    texture_id: []const u8,
    tile_x: i64,
    tile_y: i64,
    mip_level: i64,
