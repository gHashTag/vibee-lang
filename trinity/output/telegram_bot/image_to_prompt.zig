// ═══════════════════════════════════════════════════════════════════════════════
// image_to_prompt v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const DEFAULT_DETAIL_LEVEL: f64 = 0;

pub const MAX_PROMPT_LENGTH: f64 = 500;

pub const VISION_MODEL: f64 = 0;
...
pub const ImageToPromptRequest = struct {
    image_url: []const u8,
...
pub const ImageToPromptResponse = struct {
    success: bool,
    prompt: ?[]const u8,
...
test "generate_recreation_prompt" {
// Given: Image URL
