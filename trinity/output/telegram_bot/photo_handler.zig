// ═══════════════════════════════════════════════════════════════════════════════
// photo_handler v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const MAX_PHOTO_SIZE_MB: f64 = 20;

pub const MIN_PHOTO_DIMENSION: f64 = 256;

pub const MAX_PHOTO_DIMENSION: f64 = 4096;
...
/// Photo handling result
pub const PhotoHandlerResult = struct {
    success: bool,
    photo_url: ?[]const u8,
    @"error": ?[]const u8,
};
...
pub const PhotoValidation = struct {
    is_valid: bool,
...
/// State for multi-photo upload
pub const MultiPhotoState = struct {
    photos: []const u8,
    expected_count: i64,
    current_count: i64,
    is_complete: bool,
...
test "handle_multi_photo_upload" {
