// ═══════════════════════════════════════════════════════════════════════════════
// voice_avatar v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const MIN_SAMPLE_DURATION_SEC: f64 = 30;
...
/// Voice avatar creation request
pub const VoiceAvatarRequest = struct {
...
/// Voice avatar creation response
pub const VoiceAvatarResponse = struct {
    success: bool,
    voice_id: ?[]const u8,
    message: ?[]const u8,
    @"error": ?[]const u8,
...
pub const VoiceCloneStatus = struct {
};

/// User's voice avatar
pub const UserVoiceAvatar = struct {
    id: []const u8,
    user_id: []const u8,
    voice_id: []const u8,
    name: []const u8,
...
test "generate_speech_with_avatar" {
