// ═══════════════════════════════════════════════════════════════════════════════
// chat_with_avatar v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const MAX_HISTORY_MESSAGES: f64 = 20;
...
pub const AvatarPersonality = struct {
    name: []const u8,
    company: ?[]const u8,
    position: ?[]const u8,
    skills: []const u8,
...
test "update_avatar_personality" {
