// ═══════════════════════════════════════════════════════════════════════════════
// auth_middleware v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const RATE_LIMIT_REQUESTS: f64 = 30;

pub const RATE_LIMIT_WINDOW_SEC: f64 = 60;
