// ═══════════════════════════════════════════════════════════════════════════════
// e2e_ollama_test_v22 v22.5.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const OllamaTestConfig = struct {
    endpoint: []const u8,
    model: []const u8,
    timeout_ms: i64,
    max_tokens: i64,
...
/// 
pub const OllamaTestResult = struct {
    test_name: []const u8,
    passed: bool,
    duration_ms: i64,
    tokens_used: i64,
...
/// 
pub const GenerationTest = struct {
    prompt: []const u8,
...
/// 
pub const OllamaTestSuite = struct {
    config: []const u8,
    results: []const u8,
    total_passed: i64,
    total_failed: i64,
