// ═══════════════════════════════════════════════════════════════════════════════
// hsh_cas_v193 v193.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DeduplicationResult = struct {
    original_size: i64,
