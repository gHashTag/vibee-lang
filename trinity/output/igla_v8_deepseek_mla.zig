// ═══════════════════════════════════════════════════════════════════════════════
// igla_v8_deepseek_mla v8.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const LatentKV = struct {
    compressed_kv: []const u8,
    projection_down: []const u8,
    projection_up: []const u8,
};

/// 
pub const MLAOutput = struct {
