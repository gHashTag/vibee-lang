// ═══════════════════════════════════════════════════════════════════════════════
// "Integration with vibee CLI" v6.8.6 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"papers": [...]}', expected='{"tree": {...}}'
}
...
// When: Path finding
// Then: Optimal path
// Test case: input='{"from": "T0.1", "to": "T5.4"}', expected='{"path": [...]}'
}
...
// Then: GPU hours, cost
// Test case: input='{"model_size": "7B"}', expected='{"gpu_hours": 1000}'
}
...
// Then: Generated .zig
// Test case: input='{"spec": "..."}', expected='{"code": "..."}'
}
...
// Test case: input='{"problem": "..."}', expected='{"daemons": [...]}'
}
