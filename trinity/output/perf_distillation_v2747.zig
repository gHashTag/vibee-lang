// ═══════════════════════════════════════════════════════════════════════════════
// perf_distillation_v2747 v2747.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DistillRequest = struct {
...
/// 
pub const DistillConfig = struct {
    epochs: i64,
    batch_size: i64,
    learning_rate: f64,
    temperature: f64,
...
/// 
pub const TeacherOutput = struct {
    logits: []const u8,
