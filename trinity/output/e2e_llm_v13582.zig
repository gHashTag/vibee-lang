// ═══════════════════════════════════════════════════════════════════════════════
// e2e_llm v13582 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const LLMTestResult = struct {
    test_id: []const u8,
    passed: bool,
...
/// 
pub const LLMTestMetrics = struct {
    total_tests: i64,
    passed: i64,
    avg_latency_ms: f64,
    avg_quality: f64,
