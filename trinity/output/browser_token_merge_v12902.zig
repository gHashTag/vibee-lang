// ═══════════════════════════════════════════════════════════════════════════════
// browser_token_merge_v12902 v12902.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MergeDecision = struct {
    source_tokens: []const u8,
    target_token: i64,
    similarity_score: f64,
};

/// 
pub const MergedSequence = struct {
    tokens: []const u8,
    merge_map: []const u8,
    reduction_ratio: f64,
};
