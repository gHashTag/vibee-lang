// ═══════════════════════════════════════════════════════════════════════════════
// igla_model_7b v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const Model7BConfig = struct {
    hidden_size: i64,
    num_layers: i64,
    num_heads: i64,
    num_kv_heads: i64,
...
/// 
pub const Model7BArchitecture = struct {
    params_billions: f64,
    flops_per_token: f64,
    memory_fp16_gb: f64,
    memory_int4_gb: f64,
...
/// 
pub const Model7BTraining = struct {
...
/// 
pub const Model7BMetrics = struct {
    humaneval: f64,
    mmlu: f64,
    gsm8k: f64,
    hellaswag: f64,
