// ═══════════════════════════════════════════════════════════════════════════════
// zig_observation v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ObservationType = struct {
};

/// 
pub const ElementObservation = struct {
    tag: []const u8,
    role: []const u8,
    name: []const u8,
    value: ?[]const u8,
...
/// 
pub const PageObservation = struct {
    url: []const u8,
    title: []const u8,
