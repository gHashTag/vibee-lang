// ═══════════════════════════════════════════════════════════════════════════════
// igla_v8_phi3 v8.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const Phi3Config = struct {
    model_size: []const u8,
    data_quality: []const u8,
    reasoning_enhanced: bool,
};

/// 
pub const DataCuration = struct {
    synthetic_data: bool,
    quality_filter: f64,
};

/// 
pub const ReasoningModule = struct {
