// ═══════════════════════════════════════════════════════════════════════════════
// collab_video v13526 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const VideoConfig = struct {
    ...
    video_quality: []const u8,
    audio_quality: []const u8,
...
/// 
pub const VideoMetrics = struct {
    calls_total: i64,
    participants_total: i64,
    avg_duration_ms: i64,
    quality_score: f64,
};

/// 
pub const VideoLayout = struct {
    layout_type: []const u8,
    focused_user: []const u8,
    grid_size: i64,
};
