// ═══════════════════════════════════════════════════════════════════════════════
// e2e_mobile_v303 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MobileViewport = struct {
    width: i64,
    height: i64,
...
/// 
pub const MobileNetwork = struct {
    @"type": []const u8,
    download_kbps: i64,
    upload_kbps: i64,
    latency_ms: i64,
...
/// 
pub const MobileTestCase = struct {
    name: []const u8,
    device: MobileDevice,
    gestures: []const u8,
