// ═══════════════════════════════════════════════════════════════════════════════
// bindless_v2665 v2665.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const BindlessStats = struct {
    textures_bound: i64,
    buffers_bound: i64,
    bind_calls_saved: i64,
    heap_utilization: f64,
};

/// 
pub const BindlessConfig = struct {
    max_textures: i64,
    max_buffers: i64,
    max_samplers: i64,
    tier: i64,
