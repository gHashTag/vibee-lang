// ═══════════════════════════════════════════════════════════════════════════════
// igla_v4_smoothquant v4.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SmoothConfig = struct {
    alpha: f64,
    per_channel: bool,
    calibration_size: i64,
};

/// 
pub const ActivationStats = struct {
    max_per_channel: []const u8,
    mean_per_channel: []const u8,
};

/// 
pub const SmoothScale = struct {
    s_activation: []const u8,
    s_weight: []const u8,
};
