// ═══════════════════════════════════════════════════════════════════════════════
// linear_algebra v2.6.8 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DecompositionType = struct {
};
...
// Test case: input='{"a": {...}, "b": {...}}', expected='{"result": {...}}'
}
...
// Test case: input='{"matrix": {...}}', expected='{"transposed": {...}}'
}
...
// Test case: input='{"matrix": {...}}', expected='{"l": {...}, "u": {...}}'
}
...
// Test case: input='{"matrix": {...}}', expected='{"q": {...}, "r": {...}}'
}
...
// Test case: input='{"matrix": {...}}', expected='{"u": {...}, "s": [...], "vt": {...}}'
}
