// ═══════════════════════════════════════════════════════════════════════════════
// agent_action_space v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ActionConstraint = struct {
    constraint_id: []const u8,
    constraint_type: []const u8,
    affected_actions: []const u8,
    condition: []const u8,
};

/// 
pub const ActionSelection = struct {
...
/// 
pub const ActionPrefix = struct {
    prefix: []const u8,
    actions_with_prefix: []const u8,
    can_constrain: bool,
};
