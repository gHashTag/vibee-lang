// ═══════════════════════════════════════════════════════════════════════════════
// agent_auth_2fa v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const TwoFactorChallenge = struct {
...
/// 
pub const TwoFactorCode = struct {
    code: []const u8,
    method: []const u8,
    timestamp: i64,
};
...
/// 
pub const TwoFactorResult = struct {
    success: bool,
