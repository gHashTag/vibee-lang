// ═══════════════════════════════════════════════════════════════════════════════
// safety_constraints v6.5.3 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ConstraintSet = struct {
    hard_constraints: []const u8,
    soft_constraints: []const u8,
};

/// 
pub const ConstraintResult = struct {
    satisfied: bool,
    margin: f64,
...
test "check_gradient_constraint" {
...
test "check_capability_constraint" {
