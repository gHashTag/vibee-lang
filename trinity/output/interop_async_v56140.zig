// ═══════════════════════════════════════════════════════════════════════════════
// interop_async_v56140 v56.1.40 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AsyncCallback = struct {
    on_success: []const u8,
    on_error: []const u8,
    on_cancel: []const u8,
    user_data: []const u8,
