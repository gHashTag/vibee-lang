// ═══════════════════════════════════════════════════════════════════════════════
// igla_v5_lookahead v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const JacobiState = struct {
    current_guess: []const u8,
    previous_guess: []const u8,
    converged: bool,
};

/// 
pub const NGramPool = struct {
    pool_size: i64,
    n_grams: []const u8,
    hit_rate: f64,
};
