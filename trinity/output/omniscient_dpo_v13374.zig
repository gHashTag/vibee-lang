// ═══════════════════════════════════════════════════════════════════════════════
// omniscient_dpo v13374.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DPOResult = struct {
    model_updated: bool,
    loss_history: []const u8,
    preference_accuracy: f64,
};
