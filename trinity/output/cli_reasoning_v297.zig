// ═══════════════════════════════════════════════════════════════════════════════
// cli_reasoning v2.9.7 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"task": "Solve: 2+2"}', expected='{"answer": "4"}'
}
...
// Test case: input='{"goal": "Build feature X"}', expected='{"plan": [...]}'
}
...
// Test case: input='{"action": "search", "args": {...}}', expected='{"observation": "..."}'
}
...
// When: Reflection
// Then: Self-evaluate
// Test case: input='{"trace": {...}}', expected='{"feedback": "..."}'
}
...
// Test case: input='{"state": {...}, "branches": 3}', expected='{"paths": [...]}'
}
...
// When: Evaluation
// Then: Score answer
// Test case: input='{"answer": "4", "expected": "4"}', expected='{"correct": true}'
}
