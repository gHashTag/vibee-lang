// ═══════════════════════════════════════════════════════════════════════════════
// safety_content_filter_v2741 v2741.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const FilterResult = struct {
    is_safe: bool,
    flagged_categories: []const u8,
    confidence_scores: []const u8,
};

/// 
pub const ContentCategory = struct {
...
/// 
pub const FilteredContent = struct {
    original: []const u8,
    filtered: []const u8,
    redactions: []const u8,
};
