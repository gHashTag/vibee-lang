// ═══════════════════════════════════════════════════════════════════════════════
// spec_parser v9.6.4 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// When: Parsing
// Then: AST produced
// Test case: input='{"spec": "name: test\\nversion: 1.0"}', expected='{"ast": {"name": "test", "version": "1.0"}}'
}
...
// Test case: input='{"ast": {...}}', expected='{"types": [...]}'
}

test "extract_behaviors" {
// Given: Parsed AST
// When: Behavior extraction
// Then: Behavior definitions
// Test case: input='{"ast": {...}}', expected='{"behaviors": [...]}'
}
...
test "to_training_format" {
// Given: Parsed AST
// When: Format conversion
// Then: Training data
// Test case: input='{"ast": {...}}', expected='{"training_data": {...}}'
}
