// ═══════════════════════════════════════════════════════════════════════════════
// task_planning_v13670 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const PlanningDomain = struct {
    pddl: []const u8,
    behavior_tree: []const u8,
    hierarchical: []const u8,
    llm_based: []const u8,
};

/// 
pub const TaskGoal = struct {
    goal_state: []const u8,
...
/// 
pub const ActionPrimitive = struct {
    name: []const u8,
