// ═══════════════════════════════════════════════════════════════════════════════
// zig_huggingface_provider v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const HF_ROUTER_URL: f64 = 0;

pub const GPT_OSS_120B: f64 = 0;

pub const DEEPSEEK_R1: f64 = 0;

pub const LLAMA_33_70B: f64 = 0;

pub const QWEN_25_72B: f64 = 0;
...
pub const HFConfig = struct {
    ...
    max_tokens: i64,
    temperature: f64,
    provider_policy: []const u8,
};

/// 
pub const HFResponse = struct {
    content: []const u8,
