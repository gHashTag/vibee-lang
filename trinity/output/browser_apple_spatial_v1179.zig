// ═══════════════════════════════════════════════════════════════════════════════
// browser_apple_spatial_v1179 v12.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SpatialSource = struct {
    id: []const u8,
    position: []const u8,
    distance: f64,
    attenuation: f64,
...
/// 
pub const SpatialListener = struct {
    position: []const u8,
...
/// 
pub const SpatialEnvironment = struct {
    reverb_preset: []const u8,
    room_size: f64,
    damping: f64,
};
