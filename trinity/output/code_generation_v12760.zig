// ═══════════════════════════════════════════════════════════════════════════════
// code_generation_v12760 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const GenerationMode = struct {
    completion: []const u8,
    infilling: []const u8,
    translation: []const u8,
    refactoring: []const u8,
};
...
/// 
pub const CodeValidation = struct {
    code_id: []const u8,
    syntax_valid: bool,
    type_check: bool,
    tests_pass: bool,
