// ═══════════════════════════════════════════════════════════════════════════════
// pool_object_v585 v585.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ObjectFactory = struct {
    ...
    create_fn: []const u8,
    reset_fn: []const u8,
    validate_fn: []const u8,
};

/// 
pub const ObjectPoolMetrics = struct {
    objects_created: i64,
    objects_recycled: i64,
    recycle_rate: f64,
    phi_efficiency: f64,
};
