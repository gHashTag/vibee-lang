// ═══════════════════════════════════════════════════════════════════════════════
// e2e_onnx v13586 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ONNXTestSuite = struct {
    suite_id: []const u8,
    models: []const u8,
    tests: []const u8,
};
...
/// 
pub const ONNXTestResult = struct {
    test_id: []const u8,
    passed: bool,
    inference_ms: f64,
    accuracy: f64,
...
/// 
pub const ONNXTestMetrics = struct {
    total_tests: i64,
    passed: i64,
