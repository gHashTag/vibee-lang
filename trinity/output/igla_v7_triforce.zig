// ═══════════════════════════════════════════════════════════════════════════════
// igla_v7_triforce v7.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const TriForceConfig = struct {
    num_levels: i64,
    draft_lengths: []const u8,
    retrieval_enabled: bool,
};

/// 
pub const HierarchicalDraft = struct {
    level: i64,
...
/// 
pub const TriForceResult = struct {
    accepted_tokens: i64,
    levels_used: []const u8,
    speedup: f64,
};
