// ═══════════════════════════════════════════════════════════════════════════════
// igla_training_fusion v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FusionPipeline = struct {
    data_pipeline: []const u8,
    tokenizer: []const u8,
...
/// 
pub const KosheyIntegration = struct {
    ring_attention: bool,
    ewc_enabled: bool,
    moe_enabled: bool,
