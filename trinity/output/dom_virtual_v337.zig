// ═══════════════════════════════════════════════════════════════════════════════
// dom_virtual_v337 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const VirtualScroll = struct {
    scroll_top: i64,
    scroll_height: i64,
    viewport_height: i64,
    buffer_size: i64,
...
/// 
pub const ScrollStrategy = struct {
    @"type": []const u8,
    threshold: i64,
    debounce_ms: i64,
};
...
/// 
pub const VirtualConfig = struct {
