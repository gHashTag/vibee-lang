// ═══════════════════════════════════════════════════════════════════════════════
// brain_interface_v12940 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const InterfaceType = struct {
    invasive: []const u8,
    semi_invasive: []const u8,
    non_invasive: []const u8,
};

/// 
pub const NeuralSignal = struct {
    id: []const u8,
    channel: i64,
    samples: []const u8,
...
/// 
pub const DecodedIntent = struct {
    decoder_id: []const u8,
    intent: []const u8,
    confidence: f64,
    latency_ms: i64,
