// ═══════════════════════════════════════════════════════════════════════════════
// perf_vectorize v13572 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const VectorizeConfig = struct {
    simd_width: i64,
...
/// 
pub const VectorizedCode = struct {
    original: []const u8,
    vectorized: []const u8,
    speedup: f64,
    simd_instructions: []const u8,
};

/// 
pub const VectorizeAnalysis = struct {
    loops_analyzed: i64,
...
/// 
pub const SIMDInstruction = struct {
...
/// 
pub const VectorizeMetrics = struct {
    code_vectorized: i64,
    avg_speedup: f64,
...
/// 
pub const VectorizeReport = struct {
    analysis: []const u8,
