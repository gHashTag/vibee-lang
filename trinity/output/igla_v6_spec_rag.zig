// ═══════════════════════════════════════════════════════════════════════════════
// igla_v6_spec_rag v6.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RAGDraft = struct {
    draft_id: i64,
    retrieved_docs: []const u8,
    draft_response: []const u8,
};

/// 
pub const SpecRAGOutput = struct {
