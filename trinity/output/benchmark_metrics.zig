// ═══════════════════════════════════════════════════════════════════════════════
// benchmark_metrics v11.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const PerformanceReport = struct {
    ...
    comparisons: std.StringHashMap([]const u8),
    timestamp: i64,
};
...
pub const BenchmarkComparison = struct {
    ...
    improvements: std.StringHashMap([]const u8),
    regressions: std.StringHashMap([]const u8),
};
