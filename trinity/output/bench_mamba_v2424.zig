// ═══════════════════════════════════════════════════════════════════════════════
// bench_mamba_v2424 v2424.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const BenchComparison = struct {
    mamba_result: []const u8,
    transformer_result: []const u8,
    speedup_factor: f64,
...
test "bench_mamba_vs_transformer" {
