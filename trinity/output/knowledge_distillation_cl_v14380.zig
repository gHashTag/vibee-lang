// ═══════════════════════════════════════════════════════════════════════════════
// knowledge_distillation_cl_v14380 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DistillationType = struct {
    logit: []const u8,
    feature: []const u8,
    attention: []const u8,
    relation: []const u8,
...
/// 
pub const KDCLConfig = struct {
    distill_type: []const u8,
    temperature: f64,
    alpha: f64,
};
