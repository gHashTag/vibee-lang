// ═══════════════════════════════════════════════════════════════════════════════
// agent_observability_v10733 v10733.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DistributedTrace = struct {
    trace_id: []const u8,
    spans: []const u8,
    start_time: i64,
    duration_us: i64,
...
/// 
pub const MetricAggregation = struct {
    metric_name: []const u8,
    aggregation_type: []const u8,
    value: f64,
    timestamp: i64,
    dimensions: []const u8,
};
...
/// 
pub const LogAggregation = struct {
    log_id: []const u8,
    level: []const u8,
    message: []const u8,
    service: []const u8,
...
/// 
pub const AlertInstance = struct {
    alert_id: []const u8,
    rule_id: []const u8,
    status: []const u8,
    fired_at: i64,
