// ═══════════════════════════════════════════════════════════════════════════════
// igla_v7_griffin v7.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const GriffinConfig = struct {
    ...
    recurrence_width: i64,
};

/// 
pub const RGLRUBlock = struct {
    input_gate: []const u8,
    recurrence_gate: []const u8,
    linear_recurrence: []const u8,
};

/// 
pub const GriffinState = struct {
    recurrent_state: []const u8,
    gate_state: []const u8,
};
