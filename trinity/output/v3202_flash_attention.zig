// ═══════════════════════════════════════════════════════════════════════════════
// flash_attention v3.2.2 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const BLOCK_SIZE_Q: f64 = 64;

pub const BLOCK_SIZE_KV: f64 = 64;

pub const SRAM_SIZE: f64 = 65536;
...
/// 
pub const TiledState = struct {
    output_block: []const u8,
    row_max: []const u8,
    row_sum: []const u8,
};
