// ═══════════════════════════════════════════════════════════════════════════════
// igla_v4_dora v4.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const DoRALayer = struct {
    magnitude: []const u8,
    direction_lora_A: []const u8,
    direction_lora_B: []const u8,
    base_weight: []const u8,
};

/// 
pub const DoRAMerge = struct {
    merged_weight: []const u8,
    scale_factor: f64,
};
