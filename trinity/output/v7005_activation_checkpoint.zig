// ═══════════════════════════════════════════════════════════════════════════════
// activation_checkpoint v7.0.5 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CheckpointSegment = struct {
    segment_id: i64,
    start_layer: i64,
    end_layer: i64,
};
...
/// 
pub const RecomputeState = struct {
    saved_inputs: []const u8,
    rng_state: []const u8,
};
