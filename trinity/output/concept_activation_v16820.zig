// ═══════════════════════════════════════════════════════════════════════════════
// concept_activation_v16820 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ConceptVector = struct {
    concept: []const u8,
    vector: []const u8,
    layer: i64,
};
...
/// 
pub const ConceptSet = struct {
    positive_examples: []const u8,
    negative_examples: []const u8,
};

/// 
pub const TCAVConfig = struct {
    layer: i64,
    num_runs: i64,
};
