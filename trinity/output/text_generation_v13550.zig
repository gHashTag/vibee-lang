// ═══════════════════════════════════════════════════════════════════════════════
// text_generation_v13550 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DecodingStrategy = struct {
    greedy: []const u8,
    beam_search: []const u8,
    nucleus: []const u8,
    contrastive: []const u8,
};
...
/// 
pub const TextGenConfig = struct {
    strategy: []const u8,
    temperature: f64,
    top_p: f64,
