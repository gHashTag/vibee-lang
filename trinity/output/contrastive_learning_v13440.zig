// ═══════════════════════════════════════════════════════════════════════════════
// contrastive_learning_v13440 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const EmbeddingPair = struct {
    anchor: []const u8,
    positive: []const u8,
    negative: []const u8,
};
...
/// 
pub const ContrastiveOutput = struct {
    loss: f64,
    accuracy: f64,
