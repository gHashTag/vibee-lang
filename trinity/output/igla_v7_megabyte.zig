// ═══════════════════════════════════════════════════════════════════════════════
// igla_v7_megabyte v7.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MegabyteConfig = struct {
    patch_size: i64,
    global_layers: i64,
    local_layers: i64,
};
...
pub const GlobalModel = struct {
    ...
    global_transformer: []const u8,
};

/// 
pub const LocalModel = struct {
    byte_embeddings: []const u8,
    local_transformer: []const u8,
};
