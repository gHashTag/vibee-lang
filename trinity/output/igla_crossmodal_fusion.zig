// ═══════════════════════════════════════════════════════════════════════════════
// igla_crossmodal_fusion v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FusedEmbedding = struct {
    embedding: []const u8,
    contributing_modalities: []const u8,
    fusion_confidence: f64,
};

/// 
pub const AttentionFusion = struct {
    query: []const u8,
    keys: []const u8,
    values: []const u8,
...
/// 
pub const GatedFusion = struct {
    gate_weights: []const u8,
    fused_output: []const u8,
};
