// ═══════════════════════════════════════════════════════════════════════════════
// paper_tensor_parallel_v592 v592.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ShardedTensor = struct {
    tensor_id: []const u8,
    shard_dim: i64,
    local_shard: []const u8,
    global_shape: []const u8,
};
...
/// 
pub const TensorParallelMetrics = struct {
    compute_time_ms: f64,
