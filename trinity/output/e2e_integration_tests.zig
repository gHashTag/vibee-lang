// ═══════════════════════════════════════════════════════════════════════════════
// e2e_integration_tests v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const IntegrationTest = struct {
    test_id: []const u8,
    components: []const u8,
    expected_flow: []const u8,
};

/// 
pub const PipelineTest = struct {
    start_component: []const u8,
    end_component: []const u8,
    data_flow: []const u8,
};

/// 
pub const BridgeTest = struct {
    request_type: []const u8,
    expected_response: []const u8,
};

/// 
pub const EndToEndTest = struct {
    user_task: []const u8,
    expected_outcome: []const u8,
    components_involved: []const u8,
};
