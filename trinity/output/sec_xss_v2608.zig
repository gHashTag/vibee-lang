// ═══════════════════════════════════════════════════════════════════════════════
// sec_xss_v2608 v2608.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const SanitizeConfig = struct {
    allowed_tags: []const u8,
    allowed_attrs: []const u8,
    strip_comments: bool,
    encode_entities: bool,
};

/// 
pub const XSSDetection = struct {
    detected: bool,
    pattern: []const u8,
    position: i64,
    severity: []const u8,
...
pub const ContentSecurityPolicy = struct {
    ...
    style_src: []const u8,
    img_src: []const u8,
    connect_src: []const u8,
    frame_ancestors: []const u8,
};
