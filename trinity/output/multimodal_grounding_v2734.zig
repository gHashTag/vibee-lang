// ═══════════════════════════════════════════════════════════════════════════════
// multimodal_grounding_v2734 v2734.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const GroundingRequest = struct {
    image: []const u8,
    text_query: []const u8,
    return_mask: bool,
};
...
pub const GroundingResult = struct {
    bounding_boxes: []const u8,
    masks: []const u8,
    confidence_scores: []const u8,
};

/// 
pub const ReferringExpression = struct {
    expression: []const u8,
    target_box: []const u8,
    confidence: f64,
};
