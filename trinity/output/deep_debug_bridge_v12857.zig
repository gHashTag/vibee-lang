// ═══════════════════════════════════════════════════════════════════════════════
// deep_debug_bridge_v12857 v12857.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DebugBridge = struct {
    bridge_id: []const u8,
    browser_debugger: []const u8,
    vscode_debugger: []const u8,
    connected: bool,
};

/// 
pub const UnifiedBreakpoint = struct {
    breakpoint_id: []const u8,
    browser_location: []const u8,
    vscode_location: []const u8,
    synced: bool,
};
