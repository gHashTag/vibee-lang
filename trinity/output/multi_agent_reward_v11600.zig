// ═══════════════════════════════════════════════════════════════════════════════
// multi_agent_reward_v11600 v11600 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const RewardConfig = struct {
    ...
    team_reward_weight: f64,
    individual_reward_weight: f64,
};

/// 
pub const RewardStructure = struct {
};

/// 
pub const CreditMethod = struct {
};

/// 
pub const RewardAllocation = struct {
    agent_rewards: []const u8,
    team_reward: f64,
    fairness_index: f64,
...
/// 
pub const CreditAssignment = struct {
    agent_id: []const u8,
    contribution: f64,
    counterfactual_impact: f64,
    assigned_credit: f64,
};
...
test "compute_difference_reward" {
...
test "verify_incentive_alignment" {
