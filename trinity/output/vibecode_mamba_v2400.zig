// ═══════════════════════════════════════════════════════════════════════════════
// vibecode_mamba_v2400 v2400.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MambaCodeConfig = struct {
    model_size: []const u8,
    context_length: i64,
    code_languages: []const u8,
    use_hybrid: bool,
};
