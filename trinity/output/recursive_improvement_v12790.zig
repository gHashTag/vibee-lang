// ═══════════════════════════════════════════════════════════════════════════════
// recursive_improvement_v12790 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RecursiveState = struct {
    loop_id: []const u8,
    current_level: i64,
    accumulated_improvement: f64,
    safety_margin: f64,
};

/// 
pub const ConvergenceMetric = struct {
    loop_id: []const u8,
