// ═══════════════════════════════════════════════════════════════════════════════
// onnx_quantize v13536 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const QuantizeConfig = struct {
    quantize_type: []const u8,
...
/// 
pub const QuantizeMetrics = struct {
    models_quantized: i64,
    avg_size_reduction: f64,
    avg_speedup: f64,
    avg_accuracy_loss: f64,
};
...
/// 
pub const DynamicQuantize = struct {
    enabled: bool,
    weight_type: []const u8,
    activation_type: []const u8,
};
