// ═══════════════════════════════════════════════════════════════════════════════
// gaia_tool_chain v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ChainExecution = struct {
...
/// 
pub const ToolDependency = struct {
...
/// 
pub const ChainOptimization = struct {
    optimization_id: []const u8,
    original_chain: []const u8,
    optimized_chain: []const u8,
    steps_saved: i64,
};
