// ═══════════════════════════════════════════════════════════════════════════════
// attention_viz_v11890 v11890 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const HeadSelection = struct {
};
...
/// 
pub const AttentionAnalysis = struct {
    patterns: []const u8,
    important_tokens: []const u8,
...
test "identify_important_tokens" {
// Given: Attention weights
