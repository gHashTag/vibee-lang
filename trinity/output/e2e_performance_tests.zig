// ═══════════════════════════════════════════════════════════════════════════════
// e2e_performance_tests v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ThroughputTest = struct {
    operation: []const u8,
    min_ops_per_sec: i64,
    duration_sec: i64,
};
...
test "test_extraction_throughput" {
