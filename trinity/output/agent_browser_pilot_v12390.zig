// ═══════════════════════════════════════════════════════════════════════════════
// agent_browser_pilot_v12390 v12390.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const PilotResult = struct {
    success: bool,
    steps_executed: []const u8,
    final_state: []const u8,
    error_message: []const u8,
};

/// 
pub const PilotConfig = struct {
    headless: bool,
    timeout_ms: i64,
    retry_count: i64,
