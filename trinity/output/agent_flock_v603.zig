// ═══════════════════════════════════════════════════════════════════════════════
// agent_flock_v603 v603.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FlockFormation = struct {
    formation_id: []const u8,
    pattern: []const u8,
    spacing: f64,
    phi_ratio: f64,
};
...
/// 
pub const FlockMetrics = struct {
    boids_count: i64,
    avg_speed: f64,
    formation_accuracy: f64,
    phi_alignment: f64,
};
