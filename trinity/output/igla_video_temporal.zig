// ═══════════════════════════════════════════════════════════════════════════════
// igla_video_temporal v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ActionBoundary = struct {
    frame_id: i64,
    confidence: f64,
    action_before: []const u8,
    action_after: []const u8,
};
...
/// 
pub const MotionFeature = struct {
