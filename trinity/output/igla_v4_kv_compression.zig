// ═══════════════════════════════════════════════════════════════════════════════
// igla_v4_kv_compression v4.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const KVCompressConfig = struct {
    budget_ratio: f64,
    heavy_hitter_ratio: f64,
    recent_window: i64,
};

/// 
pub const AttentionScores = struct {
    cumulative_scores: []const u8,
    position_ids: []const u8,
};

/// 
pub const CompressedKV = struct {
    heavy_hitters: []const u8,
