// ═══════════════════════════════════════════════════════════════════════════════
// igla_v7_sequoia v7.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SequoiaConfig = struct {
    tree_depth: i64,
    tree_width: i64,
...
/// 
pub const SequoiaResult = struct {
    accepted_path: []const u8,
    tree_efficiency: f64,
    tokens_accepted: i64,
};
