// ═══════════════════════════════════════════════════════════════════════════════
// collab_awareness_v12882 v12882.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AwarenessRoom = struct {
    room_id: []const u8,
    users: []const u8,
    state_map: []const u8,
};
...
/// 
pub const AwarenessConfig = struct {
...
/// 
pub const AwarenessMetrics = struct {
    active_users: i64,
    updates_per_sec: f64,
    avg_latency_ms: f64,
};
