// ═══════════════════════════════════════════════════════════════════════════════
// tensorrt v8.0.1 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const TRTConfig = struct {
    precision: []const u8,
    max_workspace_size: i64,
    max_batch_size: i64,
};

/// 
pub const TRTEngine = struct {
    engine_bytes: []const u8,
    input_shapes: []const u8,
    output_shapes: []const u8,
};

/// 
pub const OptimizationProfile = struct {
    min_shapes: std.StringHashMap([]const u8),
    opt_shapes: std.StringHashMap([]const u8),
    max_shapes: std.StringHashMap([]const u8),
};
