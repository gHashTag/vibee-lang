// ═══════════════════════════════════════════════════════════════════════════════
// agent_memory_episodic v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const EpisodeQuery = struct {
    task_similar_to: ?[]const u8,
    time_range: ?[]const u8,
    outcome_filter: ?[]const u8,
};
...
/// 
pub const LessonLearned = struct {
    episode_id: []const u8,
    lesson: []const u8,
