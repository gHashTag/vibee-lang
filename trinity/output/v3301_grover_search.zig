// ═══════════════════════════════════════════════════════════════════════════════
// grover_search v3.3.1 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const AMPLIFICATION_FACTOR: f64 = 1.618;

pub const OPTIMAL_ITERATIONS_FACTOR: f64 = 0.785;
...
/// 
pub const AmplitudeState = struct {
    amplitudes: []const u8,
    num_iterations: i64,
};
