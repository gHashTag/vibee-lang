// ═══════════════════════════════════════════════════════════════════════════════
// multi_agent_alignment_v11560 v11560 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AggregationMethod = struct {
};
...
pub const ValueConflict = struct {
    agents: []const u8,
    conflicting_values: []const u8,
    resolution_possible: bool,
    compromise_score: f64,
};
