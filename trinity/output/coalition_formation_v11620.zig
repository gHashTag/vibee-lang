// ═══════════════════════════════════════════════════════════════════════════════
// coalition_formation_v11620 v11620 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CoalitionConfig = struct {
    formation_rule: FormationRule,
    stability_requirement: StabilityType,
    max_coalition_size: i64,
    allow_overlapping: bool,
};

/// 
pub const FormationRule = struct {
};

/// 
pub const StabilityType = struct {
};

/// 
pub const Coalition = struct {
    coalition_id: []const u8,
    members: []const u8,
    value: f64,
    stability_score: f64,
    formation_time: i64,
...
/// 
pub const CoalitionTransition = struct {
    from_coalition: []const u8,
    to_coalition: []const u8,
    agent: []const u8,
    approved: bool,
};
