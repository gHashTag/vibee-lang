// ═══════════════════════════════════════════════════════════════════════════════
// data_partitioning_v12470 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const PartitionStrategy = struct {
    hash: []const u8,
    range: []const u8,
    list: []const u8,
    composite: []const u8,
...
/// 
pub const RebalanceOperation = struct {
    id: []const u8,
    from_partition: []const u8,
    to_partition: []const u8,
    keys_moved: i64,
    status: []const u8,
};
