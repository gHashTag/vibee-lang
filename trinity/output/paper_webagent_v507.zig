// ═══════════════════════════════════════════════════════════════════════════════
// paper_webagent_v507 v507.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const WebAgentModel = struct {
    model_id: []const u8,
    architecture: []const u8,
    html_encoder: []const u8,
    action_decoder: []const u8,
    context_window: i64,
};
...
/// 
pub const WebAgentEvaluation = struct {
    task_success: bool,
    steps_taken: i64,
