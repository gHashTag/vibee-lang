// ═══════════════════════════════════════════════════════════════════════════════
// llvm_ir v2.2.7 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"vibee_type": "Int"}', expected='{"llvm_type": "i64"}'
}
...
// Test case: input='{"ir_func": {...}}', expected='{"llvm_func": {...}}'
}

test "emit_basic_block" {
// Given: IR block
// When: Block emission
// Then: Generate LLVM basic block
// Test case: input='{"ir_block": {...}}', expected='{"llvm_block": {...}}'
}
...
// Test case: input='{"ir_instr": "add"}', expected='{"llvm_instr": "add i64 %0, %1"}'
}
...
// Test case: input='{"module": {...}, "level": "o2"}', expected='{"optimized": {...}}'
}

test "emit_textual_ir" {
// Given: LLVM module
// When: Text output
// Then: Generate .ll file
// Test case: input='{"module": {...}}', expected='{"ir_text": "..."}'
}
