// ═══════════════════════════════════════════════════════════════════════════════
// zig_agent_react v13.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ReActConfig = struct {
    max_steps: i64,
    thought_prefix: []const u8,
    action_prefix: []const u8,
    observation_prefix: []const u8,
    final_answer_prefix: []const u8,
};
