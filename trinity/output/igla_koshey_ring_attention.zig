// ═══════════════════════════════════════════════════════════════════════════════
// igla_koshey_ring_attention v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const BlockwiseAttention = struct {
    query_block: i64,
    key_block: i64,
    value_block: i64,
    attention_scores: f64,
};

/// 
pub const InfiniteContext = struct {
    total_tokens: i64,
