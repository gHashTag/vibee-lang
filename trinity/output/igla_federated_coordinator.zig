// ═══════════════════════════════════════════════════════════════════════════════
// igla_federated_coordinator v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const FederatedRound = struct {
    round_id: i64,
    participating_nodes: []const u8,
    status: []const u8,
};

/// 
pub const NodeRegistration = struct {
    node_id: i64,
    address: []const u8,
    capacity: i64,
};
...
pub const CoordinatorStats = struct {
    ...
    avg_round_time_ms: f64,
};

/// 
pub const RoutingTable = struct {
    node_assignments: []const u8,
