// ═══════════════════════════════════════════════════════════════════════════════
// perf_dedupe v13576 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DedupeMetrics = struct {
    total_processed: i64,
    total_saved: i64,
    avg_dedupe_ratio: f64,
};

/// 
pub const DedupeIndex = struct {
    index_id: []const u8,
    entries: i64,
    size_mb: f64,
};
