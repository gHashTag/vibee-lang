// ═══════════════════════════════════════════════════════════════════════════════
// tools_perf v13560 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ToolsPerfConfig = struct {
    cache_enabled: bool,
...
/// 
pub const ToolsPerfMetrics = struct {
...
/// 
pub const ToolsPerfReport = struct {
    latency: []const u8,
    throughput: []const u8,
