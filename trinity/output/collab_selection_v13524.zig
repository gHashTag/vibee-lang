// ═══════════════════════════════════════════════════════════════════════════════
// collab_selection v13524 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const SelectionMetrics = struct {
    selections_active: i64,
    updates_sent: i64,
    conflicts_resolved: i64,
};

/// 
pub const SelectionHighlight = struct {
    user_id: []const u8,
    color: []const u8,
