// ═══════════════════════════════════════════════════════════════════════════════
// browser_mamba_v2394 v2394.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SelectiveScan = struct {
    delta: []const u8,
    A: []const u8,
    B: []const u8,
    C: []const u8,
...
test "mamba_inference_streaming" {
...
test "mamba_vs_transformer_benchmark" {
