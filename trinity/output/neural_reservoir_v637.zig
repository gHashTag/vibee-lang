// ═══════════════════════════════════════════════════════════════════════════════
// neural_reservoir_v637 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ReadoutWeights = struct {
    weights: []const u8,
    regularization: f64,
    trained: bool,
};
...
/// 
pub const ReservoirMetrics = struct {
    memory_capacity: f64,
    kernel_quality: f64,
