// ═══════════════════════════════════════════════════════════════════════════════
// omniscient_mla v13372.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const MLALayer = struct {
    layer_id: i64,
    kv_cache: []const u8,
    latent_projection: []const u8,
};

/// 
pub const MLAResult = struct {
    output: []const u8,
    memory_saved: f64,
    latency_ns: i64,
};
