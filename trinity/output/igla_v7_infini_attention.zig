// ═══════════════════════════════════════════════════════════════════════════════
// igla_v7_infini_attention v7.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CompressiveMemory = struct {
    memory_matrix: []const u8,
    normalization: []const u8,
};

/// 
pub const InfiniState = struct {
    local_attention: []const u8,
    memory_attention: []const u8,
    combined: []const u8,
};
