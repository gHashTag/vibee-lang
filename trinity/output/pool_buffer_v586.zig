// ═══════════════════════════════════════════════════════════════════════════════
// pool_buffer_v586 v586.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const BufferPool = struct {
    pool_id: []const u8,
    buffer_sizes: []const u8,
    pools_per_size: std.StringHashMap([]const u8),
    phi_sizing: bool,
};
...
/// 
pub const BufferRequest = struct {
    request_id: []const u8,
    min_size: i64,
    preferred_size: i64,
};
...
pub const BufferPoolMetrics = struct {
    buffers_allocated: i64,
    buffers_recycled: i64,
    size_distribution: std.StringHashMap([]const u8),
    phi_efficiency: f64,
};
