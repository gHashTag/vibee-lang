// ═══════════════════════════════════════════════════════════════════════════════
// igla_v4_tensor_parallel v4.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const TPConfig = struct {
    world_size: i64,
    rank: i64,
    comm_backend: []const u8,
};

/// 
pub const ColumnParallel = struct {
    weight_shard: []const u8,
    gather_output: bool,
};
