// ═══════════════════════════════════════════════════════════════════════════════
// igla_v6_sparse_attention v6.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const SparseConfig = struct {
    block_size: i64,
    num_global_tokens: i64,
    num_random_blocks: i64,
};

/// 
pub const AttentionPattern = struct {
    local_window: []const u8,
    global_tokens: []const u8,
    random_blocks: []const u8,
};

/// 
pub const SparseOutput = struct {
