// ═══════════════════════════════════════════════════════════════════════════════
// agent_selfhealing_v283 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SelfHealingAction = struct {
    id: []const u8,
