// ═══════════════════════════════════════════════════════════════════════════════
// igla_training_mixed_precision v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const PrecisionState = struct {
    current_scale: f64,
    growth_interval: i64,
    backoff_factor: f64,
    growth_factor: f64,
...
/// 
pub const CastOperation = struct {
    input_dtype: []const u8,
    output_dtype: []const u8,
    operation: []const u8,
};

/// 
pub const MixedPrecisionMetrics = struct {
    memory_savings: f64,
    speedup: f64,
    overflow_count: i64,
    effective_scale: f64,
