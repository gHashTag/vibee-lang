// ═══════════════════════════════════════════════════════════════════════════════
// quantum_oracle_v657 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const OracleCircuit = struct {
    gates: []const u8,
    depth: i64,
    t_count: i64,
};
...
pub const OracleResult = struct {
    output_state: []const u8,
    phase_kickback: bool,
    queries: i64,
};

/// 
pub const OracleMetrics = struct {
    oracles_built: i64,
    average_depth: f64,
    average_t_count: f64,
};
