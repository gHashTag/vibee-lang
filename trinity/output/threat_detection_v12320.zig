// ═══════════════════════════════════════════════════════════════════════════════
// threat_detection_v12320 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ThreatType = struct {
    intrusion: []const u8,
    malware: []const u8,
    data_exfiltration: []const u8,
    anomalous_behavior: []const u8,
};
