// ═══════════════════════════════════════════════════════════════════════════════
// flow_models_v13530 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const FlowType = struct {
    realnvp: []const u8,
    glow: []const u8,
    continuous_nf: []const u8,
    residual_flow: []const u8,
};

/// 
pub const FlowLayer = struct {
    forward_fn: []const u8,
    inverse_fn: []const u8,
    log_det_jacobian: f64,
};

/// 
pub const FlowChain = struct {
    layers: []const u8,
    num_layers: i64,
    base_distribution: []const u8,
};
