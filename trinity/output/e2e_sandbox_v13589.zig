// ═══════════════════════════════════════════════════════════════════════════════
// e2e_sandbox v13589 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SandboxTestSuite = struct {
    suite_id: []const u8,
    sandbox_types: []const u8,
    tests: []const u8,
};

/// 
pub const SandboxTestCase = struct {
    test_id: []const u8,
...
/// 
pub const SandboxTestResult = struct {
    test_id: []const u8,
    passed: bool,
    isolated: bool,
    duration_ms: i64,
...
/// 
pub const SandboxTestMetrics = struct {
    total_tests: i64,
    passed: i64,
    isolation_verified: i64,
    avg_startup_ms: f64,
};
