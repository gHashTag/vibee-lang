// ═══════════════════════════════════════════════════════════════════════════════
// mesh_shader_v2667 v2667.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const Meshlet = struct {
    vertex_offset: i64,
    vertex_count: i64,
    primitive_offset: i64,
    primitive_count: i64,
    bounds: []const u8,
};

/// 
pub const MeshShaderConfig = struct {
    max_vertices: i64,
    max_primitives: i64,
    workgroup_size: i64,
};
...
/// 
pub const MeshletStats = struct {
    meshlets_processed: i64,
    meshlets_culled: i64,
    vertices_output: i64,
    primitives_output: i64,
};
