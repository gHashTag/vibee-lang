// ═══════════════════════════════════════════════════════════════════════════════
// benchmark_performance v11.4.2 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"op": "codegen"}', expected='{"p50": 1.0, "p99": 5.0}'
}
...
// Test case: input='{"workload": "specs"}', expected='{"ops": 1000}'
}
...
// Test case: input='{"current": {...}, "baseline": {...}}', expected='{"regressions": []}'
}
