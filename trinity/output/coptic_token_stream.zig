// ═══════════════════════════════════════════════════════════════════════════════
// coptic_token_stream v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const TokenPredicate = struct {
    kind_match: i64,
    lexeme_match: []const u8,
    any_of: []const u8,
};

/// 
pub const StreamCheckpoint = struct {
    position: i64,
    state_hash: i64,
};
...
/// StreamBuilder
/// Source: Lexer -> Result: TokenStream

/// TokenFilter
/// Source: TokenStream -> Result: TokenStream
