// ═══════════════════════════════════════════════════════════════════════════════
// sequence_parallel_v2_v1833 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const DataConfig = struct {
    mixing_strategy: []const u8,
    quality_threshold: f64,
    dedup_method: []const u8,
    curriculum_order: []const u8,
};

/// 
pub const AttentionConfig = struct {
    sparse_pattern: []const u8,
    block_size: i64,
    num_sinks: i64,
    window_size: i64,
};
