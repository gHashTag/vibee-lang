// ═══════════════════════════════════════════════════════════════════════════════
// universal_transformer v9.5.5 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Then: Code generated
// Test case: input='{"input": "spec.vibee", "target": "zig"}', expected='{"code": "...", "language": "zig"}'
}
...
// Test case: input='{"content": "name: test\\nversion: 1.0"}', expected='{"type": "vibee_spec"}'
// Test case: input='{"content": "Create a user service"}', expected='{"type": "natural_language"}'
}
...
// Test case: input='{"input_type": "vibee_spec", "target": "rust"}', expected='{"pipeline": ["parse", "validate", "generate_rust"]}'
}
...
// Test case: input='{"pipeline": [...], "input": "..."}', expected='{"success": true}'
}
...
// Test case: input='{"code": "..."}', expected='{"phi_present": true}'
}
