// ═══════════════════════════════════════════════════════════════════════════════
// indirect_draw_v2666 v2666.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const IndirectCommand = struct {
    vertex_count: i64,
    instance_count: i64,
    first_vertex: i64,
    first_instance: i64,
...
/// 
pub const IndirectStats = struct {
    commands_executed: i64,
    instances_drawn: i64,
    cpu_overhead_saved_ms: f64,
    gpu_culled: i64,
};

/// 
pub const IndirectConfig = struct {
    max_commands: i64,
    gpu_culling: bool,
    count_from_gpu: bool,
    multi_draw: bool,
