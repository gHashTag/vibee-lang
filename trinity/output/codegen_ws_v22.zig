// ═══════════════════════════════════════════════════════════════════════════════
// codegen_ws_v22 v22.6.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const WsTemplate = struct {
    name: []const u8,
    message_type: []const u8,
    handler_template: []const u8,
};

/// 
pub const GeneratedHandler = struct {
    name: []const u8,
    code: []const u8,
    message_types: []const u8,
};

/// 
pub const WsCodegen = struct {
    templates: []const u8,
    protocol: []const u8,
};
