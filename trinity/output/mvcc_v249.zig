// ═══════════════════════════════════════════════════════════════════════════════
// mvcc v2.4.9 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const VersionVisibility = struct {
};
...
// Test case: input='{"data": [...], "xid": 100}', expected='{"version_id": 1}'
}
...
// Test case: input='{"version": {...}, "snapshot": {...}}', expected='{"visible": true}'
}
...
// Test case: input='{"xid": 100}', expected='{"snapshot": {...}}'
}
...
// Test case: input='{"version_id": 1, "xid": 101}', expected='{"marked": true}'
}
...
// Test case: input='{"oldest_xid": 50}', expected='{"collected": 100}'
}
...
// Test case: input='{"row_id": 1, "snapshot": {...}}', expected='{"version": {...}}'
}
