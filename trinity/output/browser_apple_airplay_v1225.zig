// ═══════════════════════════════════════════════════════════════════════════════
// browser_apple_airplay_v1225 v13.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AirPlayDevice = struct {
    id: []const u8,
    name: []const u8,
    @"type": []const u8,
    supports_video: bool,
...
/// 
pub const AirPlaySession = struct {
    device: []const u8,
...
/// 
pub const RoutePickerConfig = struct {
    button_style: []const u8,
