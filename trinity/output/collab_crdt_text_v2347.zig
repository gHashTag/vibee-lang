// ═══════════════════════════════════════════════════════════════════════════════
// collab_crdt_text_v2347 v2347.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input={ char: "a", position: 0 }, expected={ content: "a", clock_incremented: true }
}
...
// Test case: input={ position: 0 }, expected={ tombstone_created: true }
}
...
// Test case: input={ local_ops: 5, remote_ops: 3 }, expected={ consistent: true }
}
...
// Test case: input={ op1: "insert_a_0", op2: "insert_b_0" }, expected={ resolved: true }
}
