// ═══════════════════════════════════════════════════════════════════════════════
// igla_inference_batching v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const BatchScheduler = struct {
    waiting_queue: []const u8,
    running_batches: []const u8,
    max_concurrent: i64,
    strategy: []const u8,
};
...
/// 
pub const SchedulingStrategy = struct {
    name: []const u8,
    priority_weight: f64,
    fairness_weight: f64,
