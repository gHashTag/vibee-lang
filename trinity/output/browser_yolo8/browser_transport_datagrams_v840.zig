// ═══════════════════════════════════════════════════════════════════════════════
// browser_transport_datagrams_v840 v8.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const TransportConfig = struct {
    url: []const u8,
    server_certificate_hashes: []const u8,
...
// When: Create
// Then: unreliable datagrams created
