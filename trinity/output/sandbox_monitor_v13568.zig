// ═══════════════════════════════════════════════════════════════════════════════
// sandbox_monitor v13568 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ExecutionMonitor = struct {
    id: []const u8,
    sandbox_id: []const u8,
    metrics: []const u8,
};
...
/// 
pub const MonitorMetrics = struct {
    events_captured: i64,
    alerts_triggered: i64,
    avg_sample_time_ms: f64,
};
