// ═══════════════════════════════════════════════════════════════════════════════
// observation_structured v11.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const StructuredObservation = struct {
    data_type: []const u8,
    content: []const u8,
    schema: ?[]const u8,
};
...
/// 
pub const TableObservation = struct {
    headers: []const u8,
    rows: []const u8,
    row_count: i64,
    col_count: i64,
...
/// 
pub const FormObservation = struct {
    form_id: []const u8,
    fields: []const u8,
    action: []const u8,
    method: []const u8,
