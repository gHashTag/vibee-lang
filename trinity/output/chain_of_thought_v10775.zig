// ═══════════════════════════════════════════════════════════════════════════════
// chain_of_thought_v10775 v10775.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ThoughtDecomposition = struct {
    problem: []const u8,
...
/// 
pub const StepVerification = struct {
    step_id: i64,
    is_valid: bool,
    error_type: []const u8,
    correction: []const u8,
