// ═══════════════════════════════════════════════════════════════════════════════
// device_driver v2.5.7 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"driver": {...}}', expected='{"registered": true}'
}
...
// Test case: input='{"descriptor": {...}}', expected='{"handle": {...}}'
}
...
// Test case: input='{"address": 1000, "size": 4}', expected='{"value": 42}'
}
...
// Test case: input='{"address": 1000, "value": 42}', expected='{"written": true}'
}
...
// Test case: input='{"buffer": {...}, "direction": "to_device"}', expected='{"configured": true}'
}
...
// Test case: input='{"handle": {...}}', expected='{"released": true}'
}
