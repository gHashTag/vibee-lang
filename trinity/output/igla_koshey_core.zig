// ═══════════════════════════════════════════════════════════════════════════════
// igla_koshey_core v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ImmortalConfig = struct {
    ...
    death_resistance: f64,
};

/// 
pub const KosheyState = struct {
    alive: bool,
    needle_intact: bool,
...
/// 
pub const ImmortalityMetrics = struct {
    uptime_eternal: f64,
    forgetting_rate: f64,
