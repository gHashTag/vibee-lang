// ═══════════════════════════════════════════════════════════════════════════════
// igla_v6_mixture_agents v6.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AggregatorOutput = struct {
    final_response: []const u8,
    confidence: f64,
    agent_contributions: []const u8,
};
