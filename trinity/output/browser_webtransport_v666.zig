// ═══════════════════════════════════════════════════════════════════════════════
// browser_webtransport_v666 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const WebTransportConfig = struct {
    url: []const u8,
    allow_pooling: bool,
...
/// 
pub const BidirectionalStream = struct {
    readable: []const u8,
    writable: []const u8,
    stream_id: i64,
};
...
pub const DatagramChannel = struct {
    ...
    incoming_datagrams: []const u8,
    outgoing_datagrams: []const u8,
};
