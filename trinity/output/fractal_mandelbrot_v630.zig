// ═══════════════════════════════════════════════════════════════════════════════
// fractal_mandelbrot_v630 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MandelbrotConfig = struct {
    center_real: f64,
    center_imag: f64,
    zoom: f64,
    max_iterations: i64,
...
/// 
pub const MandelbrotPoint = struct {
    c_real: f64,
    c_imag: f64,
    iterations: i64,
    escaped: bool,
...
/// 
pub const MandelbrotMetrics = struct {
    total_points: i64,
