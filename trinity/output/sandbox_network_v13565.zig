// ═══════════════════════════════════════════════════════════════════════════════
// sandbox_network v13565 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const NetworkIsolation = struct {
    id: []const u8,
    policy: []const u8,
...
pub const NetworkPolicy = struct {
    policy_id: []const u8,
    ingress_rules: []const u8,
    egress_rules: []const u8,
};
...
pub const NetworkMetrics = struct {
    connections_blocked: i64,
    connections_allowed: i64,
    bytes_transferred: i64,
};

/// 
pub const NetworkViolation = struct {
