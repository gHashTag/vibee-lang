// ═══════════════════════════════════════════════════════════════════════════════
// turbo_compiler_v552 v552.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const TurboCompiler = struct {
...
/// 
pub const CompilationGraph = struct {
    graph_id: []const u8,
    nodes: []const u8,
    edges: []const u8,
...
/// 
pub const TurboCompilerMetrics = struct {
    units_compiled: i64,
    cache_hits: i64,
