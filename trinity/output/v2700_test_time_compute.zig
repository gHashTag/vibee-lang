// ═══════════════════════════════════════════════════════════════════════════════
// test_time_compute v2.7.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const TTCResult = struct {
    answer: []const u8,
    confidence: f64,
    num_samples_used: i64,
    latency_ms: f64,
};

/// 
pub const MajorityVoteConfig = struct {
    num_candidates: i64,
    temperature: f64,
};

/// 
pub const BestOfNConfig = struct {
    n: i64,
