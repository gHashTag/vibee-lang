// ═══════════════════════════════════════════════════════════════════════════════
// perf_prefetch v13574 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const PrefetchState = struct {
...
pub const PrefetchMetrics = struct {
    prefetches_total: i64,
    useful_prefetches: i64,
    wasted_prefetches: i64,
    hit_rate: f64,
};
