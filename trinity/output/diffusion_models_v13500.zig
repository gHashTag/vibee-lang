// ═══════════════════════════════════════════════════════════════════════════════
// diffusion_models_v13500 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DiffusionType = struct {
    ddpm: []const u8,
    ddim: []const u8,
    score_based: []const u8,
    flow_matching: []const u8,
};
...
/// 
pub const DiffusionOutput = struct {
    sample: []const u8,
    pred_noise: []const u8,
    pred_x0: []const u8,
};
