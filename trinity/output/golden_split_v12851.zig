// ═══════════════════════════════════════════════════════════════════════════════
// golden_split_v12851 v12851.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const GoldenSplit = struct {
    split_id: []const u8,
    primary_ratio: f64,
    secondary_ratio: f64,
    divider_position: i64,
};
...
pub const SplitState = struct {
    current_ratios: []const u8,
    dragging: bool,
    snap_to_phi: bool,
};

/// 
pub const SplitAnimation = struct {
    from_ratio: f64,
    to_ratio: f64,
    duration_ms: i64,
    easing: []const u8,
