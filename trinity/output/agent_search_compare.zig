// ═══════════════════════════════════════════════════════════════════════════════
// agent_search_compare v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const CompareResult = struct {
    ...
    comparison_time_ms: f64,
};

/// 
pub const PriceAlert = struct {
    product: []const u8,
    target_price: f64,
    current_best: f64,
