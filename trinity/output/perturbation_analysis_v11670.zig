// ═══════════════════════════════════════════════════════════════════════════════
// perturbation_analysis_v11670 v11670 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AnalysisType = struct {
};

/// 
pub const SensitivityResult = struct {
    sensitivity_score: f64,
    vulnerable_dimensions: []const u8,
    stability_radius: f64,
    gradient_norm: f64,
};

/// 
pub const PerturbationBound = struct {
    lower_bound: f64,
    upper_bound: f64,
    certified: bool,
    method: []const u8,
...
test "compute_local_sensitivity" {
...
test "find_vulnerable_dimensions" {
...
test "certify_perturbation_bound" {
