// ═══════════════════════════════════════════════════════════════════════════════
// screen_perf v13520 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ScreenPerfConfig = struct {
    gpu_capture: bool,
    zero_copy: bool,
...
/// 
pub const EncodePerf = struct {
    encode_time_ms: f64,
    bitrate_achieved: i64,
    quality_score: f64,
    gpu_utilization: f64,
};

/// 
pub const TransmitPerf = struct {
    send_time_ms: f64,
    bandwidth_used: i64,
    packets_sent: i64,
    retransmits: i64,
...
/// 
pub const ScreenPerfReport = struct {
    capture: []const u8,
    encode: []const u8,
    transmit: []const u8,
...
/// 
pub const PerfOptimization = struct {
