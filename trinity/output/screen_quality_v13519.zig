// ═══════════════════════════════════════════════════════════════════════════════
// screen_quality v13519 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const QualityDecision = struct {
    current_level: []const u8,
    recommended_level: []const u8,
    reason: []const u8,
    confidence: f64,
};
...
pub const QualityMetrics = struct {
    ...
    time_at_each_level: []const u8,
};

/// 
pub const QualityState = struct {
    current_level: []const u8,
    stable_duration_ms: i64,
    last_adaptation: i64,
};
