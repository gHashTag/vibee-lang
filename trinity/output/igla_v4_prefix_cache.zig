// ═══════════════════════════════════════════════════════════════════════════════
// igla_v4_prefix_cache v4.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const CacheHit = struct {
    matched_prefix_len: i64,
    kv_cache: []const u8,
    remaining_tokens: []const u8,
};
