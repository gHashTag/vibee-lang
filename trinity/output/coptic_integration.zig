// ═══════════════════════════════════════════════════════════════════════════════
// coptic_integration v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CompilerPipeline = struct {
    stages: []const u8,
    current_stage: i64,
    input: []const u8,
    output: []const u8,
...
/// 
pub const ComponentLink = struct {
...
/// IntegrationBuilder
/// Source: ComponentList -> Result: IntegrationLayer

/// PipelineBuilder
/// Source: StageList -> Result: CompilerPipeline
