// ═══════════════════════════════════════════════════════════════════════════════
// ai_email_calendar_v2692 v2692.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const EmailQuery = struct {
    search_term: []const u8,
    from_filter: []const u8,
    date_range: []const u8,
    has_attachment: bool,
};
...
pub const IntegrationConfig = struct {
    email_provider: []const u8,
    calendar_provider: []const u8,
