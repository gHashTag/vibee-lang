// ═══════════════════════════════════════════════════════════════════════════════
// igla_ann_benchmark v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RecallMetric = struct {
    k: i64,
    recall: f64,
    ground_truth_size: i64,
};
...
/// 
pub const ParetoCurve = struct {
    points: []const u8,
    pareto_optimal: []const u8,
};
