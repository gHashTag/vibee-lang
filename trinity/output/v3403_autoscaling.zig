// ═══════════════════════════════════════════════════════════════════════════════
// autoscaling v3.4.3 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const COOLDOWN_SECONDS: f64 = 300;

pub const PHI_SCALE_FACTOR: f64 = 1.618;
