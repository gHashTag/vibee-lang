// ═══════════════════════════════════════════════════════════════════════════════
// rag_reranking_v2728 v2728.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CrossEncoderConfig = struct {
    model_name: []const u8,
    max_length: i64,
    batch_size: i64,
};
...
/// 
pub const RerankStats = struct {
    documents_processed: i64,
    avg_score_change: f64,
