// ═══════════════════════════════════════════════════════════════════════════════
// igla_semantic_chunker v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SemanticChunk = struct {
    id: i64,
    text: []const u8,
    start_idx: i64,
    end_idx: i64,
...
/// 
pub const SimilarityBreakpoint = struct {
    position: i64,
    similarity_drop: f64,
    is_boundary: bool,
};
