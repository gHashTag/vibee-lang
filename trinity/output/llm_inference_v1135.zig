// ═══════════════════════════════════════════════════════════════════════════════
// llm_inference v11.3.5 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// When: Loading
// Then: Loaded model
// Test case: input='{"path": "model.gguf"}', expected='{"loaded": true}'
}
...
// When: Generation
// Then: Generated code
// Test case: input='{"spec": "...", "target": "Python"}', expected='{"code": "class..."}'
}
...
// When: Streaming
// Then: Token stream
// Test case: input='{"request": {...}}', expected='{"tokens": [...]}'
}
...
// Test case: input='{"requests": [...]}', expected='{"responses": [...]}'
}
