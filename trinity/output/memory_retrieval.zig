// ═══════════════════════════════════════════════════════════════════════════════
// memory_retrieval v11.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RetrievalSource = struct {
...
/// 
pub const UnifiedResult = struct {
    results: []const u8,
    sources: []const u8,
    scores: []const u8,
    fusion_score: f64,
...
pub const RerankResult = struct {
    original_order: []const u8,
    reranked_order: []const u8,
    scores: []const u8,
};
