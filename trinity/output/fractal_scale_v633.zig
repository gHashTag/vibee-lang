// ═══════════════════════════════════════════════════════════════════════════════
// fractal_scale_v633 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ScaleTransform = struct {
    factor: f64,
    center: []const u8,
...
/// 
pub const ScaleInvariance = struct {
    scale_range: []const u8,
    invariance_measure: f64,
    self_similarity: f64,
};
...
pub const ScaledResult = struct {
    original_scale: f64,
    new_scale: f64,
    detail_preserved: f64,
    computation_saved: f64,
};

/// 
pub const ScaleMetrics = struct {
    total_scalings: i64,
    average_invariance: f64,
