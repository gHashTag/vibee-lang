// ═══════════════════════════════════════════════════════════════════════════════
// browser_webxr_anchors_v937 v9.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const XRSession = struct {
    mode: []const u8,
    render_state: []const u8,
    input_sources: []const u8,
};

/// 
pub const XRReferenceSpace = struct {
    @"type": []const u8,
    bounds_geometry: []const u8,
};
...
test "request_session" {
// Given: Session mode
// When: Request
// Then: spatial anchors session obtained
    // TODO: Add test assertions
}

test "get_reference_space" {
// Given: Space type
// When: Get
