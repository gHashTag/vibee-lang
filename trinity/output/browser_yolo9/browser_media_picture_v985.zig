// ═══════════════════════════════════════════════════════════════════════════════
// browser_media_picture_v985 v9.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const MediaRecorder = struct {
    state: []const u8,
    mime_type: []const u8,
    video_bits_per_second: i64,
    audio_bits_per_second: i64,
};
...
// Given: Constraints
// When: Get
// Then: picture-in-picture stream obtained
