// ═══════════════════════════════════════════════════════════════════════════════
// igla_prompt_optimizer v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const OptimizedPrompt = struct {
    template: PromptTemplate,
    final_score: f64,
    generations_evolved: i64,
...
test "create_initial_population" {
