// ═══════════════════════════════════════════════════════════════════════════════
// collab_annotations_v12389 v12389.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DrawingAnnotation = struct {
    points: []const u8,
    stroke_width: i64,
    color: []const u8,
    tool: []const u8,
...
/// 
pub const AnnotationFilter = struct {
    user_ids: []const u8,
    types: []const u8,
    resolved: bool,
};
...
/// 
pub const AnnotationEvent = struct {
    event_type: []const u8,
    annotation: []const u8,
    user_id: []const u8,
};
