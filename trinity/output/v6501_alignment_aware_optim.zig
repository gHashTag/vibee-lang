// ═══════════════════════════════════════════════════════════════════════════════
// alignment_aware_optim v6.5.1 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ALIGNMENT_WEIGHT: f64 = 0.1;
...
/// 
pub const AlignmentConfig = struct {
    value_model: []const u8,
    alignment_loss_weight: f64,
    preserve_capabilities: bool,
};

/// 
pub const AlignmentState = struct {
    value_alignment_score: f64,
    capability_score: f64,
    pareto_optimal: bool,
};

/// 
pub const AlignmentGradient = struct {
    task_grad: []const u8,
    alignment_grad: []const u8,
    combined_grad: []const u8,
};
...
test "compute_alignment_gradient" {
