// ═══════════════════════════════════════════════════════════════════════════════
// igla_alignment_constitutional v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const Principle = struct {
    ...
    critique_prompt: []const u8,
    revision_prompt: []const u8,
};
...
test "phi_constitutional_harmony" {
// Given: Constitution
// When: Harmony
