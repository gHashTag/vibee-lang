// ═══════════════════════════════════════════════════════════════════════════════
// infra_load_balancing_v2751 v2751.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const BalancerRequest = struct {
    request: []const u8,
    strategy: []const u8,
    backends: []const u8,
};
...
/// 
pub const BalancerResult = struct {
...
/// 
pub const BalancerConfig = struct {
    strategy: []const u8,
