// ═══════════════════════════════════════════════════════════════════════════════
// event_camera_v12890 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const EventPolarity = struct {
    on: []const u8,
    off: []const u8,
};

/// 
pub const DVSEvent = struct {
    x: i64,
    y: i64,
    timestamp: i64,
    polarity: []const u8,
...
pub const EventFrame = struct {
    ...
    frame_data: []const u8,
    time_window_us: i64,
    accumulated_events: i64,
};

/// 
pub const MotionEstimate = struct {
    stream_id: []const u8,
    velocity_x: f64,
    velocity_y: f64,
    confidence: f64,
