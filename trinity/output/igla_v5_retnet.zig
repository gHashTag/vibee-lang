// ═══════════════════════════════════════════════════════════════════════════════
// igla_v5_retnet v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RetentionHead = struct {
    head_id: i64,
    decay_rate: f64,
    state: []const u8,
};
