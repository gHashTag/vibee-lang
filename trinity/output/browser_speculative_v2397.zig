// ═══════════════════════════════════════════════════════════════════════════════
// browser_speculative_v2397 v2397.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const SpecConfig = struct {
    draft_model_size: i64,
    target_model_size: i64,
...
pub const DraftTree = struct {
    ...
    tree_structure: []const u8,
    depth: i64,
};

/// 
pub const SpecOutput = struct {
    accepted_tokens: []const u8,
    acceptance_rate: f64,
    speedup_factor: f64,
    total_draft_tokens: i64,
};
...
test "speculative_speedup_benchmark" {
