// ═══════════════════════════════════════════════════════════════════════════════
// igla_selfrag_critic v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SupportScore = struct {
    score: f64,
    grounded_spans: []const u8,
    is_supported: bool,
};

/// 
pub const UtilityScore = struct {
    score: f64,
    is_useful: bool,
};

/// 
pub const CriticOutput = struct {
    relevance: f64,
    support: f64,
    utility: f64,
...
/// 
pub const ReflectionToken = struct {
    token_type: []const u8,
    value: []const u8,
    confidence: f64,
};
...
test "phi_threshold_calibration" {
