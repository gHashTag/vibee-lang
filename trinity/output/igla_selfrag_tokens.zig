// ═══════════════════════════════════════════════════════════════════════════════
// igla_selfrag_tokens v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RelevanceToken = struct {
    value: []const u8,
    level: []const u8,
};

/// 
pub const SupportToken = struct {
    value: []const u8,
    level: []const u8,
};

/// 
pub const UtilityToken = struct {
    value: []const u8,
    level: []const u8,
};
...
/// 
pub const TokenVocabulary = struct {
    retrieval_tokens: []const u8,
    relevance_tokens: []const u8,
    support_tokens: []const u8,
    utility_tokens: []const u8,
};
