// ═══════════════════════════════════════════════════════════════════════════════
// concept_activation_v11880 v11880 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ConceptConfig = struct {
    layer_name: []const u8,
    num_random_concepts: i64,
    statistical_test: []const u8,
};

/// 
pub const Concept = struct {
    concept_name: []const u8,
    positive_examples: []const u8,
    negative_examples: []const u8,
    cav_vector: []const u8,
};

/// 
pub const TCAVScore = struct {
    concept: []const u8,
    target_class: i64,
    score: f64,
    p_value: f64,
...
/// 
pub const ConceptExplanation = struct {
    concepts: []const u8,
    scores: []const u8,
    layer: []const u8,
    class_name: []const u8,
...
test "generate_concept_examples" {
