// ═══════════════════════════════════════════════════════════════════════════════
// yolo4_matryoshka_v612 v612.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const YOLO4Matryoshka = struct {
    yolo_id: []const u8,
    nesting_depth: i64,
    layers: []const u8,
    phi_factor: f64,
...
/// 
pub const MatryoshkaExecution = struct {
...
/// 
pub const YOLO4Metrics = struct {
    executions: i64,
    avg_speedup: f64,
    nesting_efficiency: f64,
    phi_optimization: f64,
};
