// ═══════════════════════════════════════════════════════════════════════════════
// browser_early_exit_v12903 v12903.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const EarlyExitResult = struct {
    output: []const u8,
    exit_layer: i64,
    layers_saved: i64,
    speedup: f64,
...
/// 
pub const ExitMetrics = struct {
    avg_exit_layer: f64,
    exit_distribution: []const u8,
    quality_vs_speed: f64,
};
