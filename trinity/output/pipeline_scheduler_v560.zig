// ═══════════════════════════════════════════════════════════════════════════════
// pipeline_scheduler_v560 v560.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const PipelineScheduler = struct {
    scheduler_id: []const u8,
    scheduling_policy: []const u8,
    stages: []const u8,
    phi_balancing: bool,
};
...
pub const SchedulingDecision = struct {
    ...
    selected_stage: []const u8,
    reason: []const u8,
    expected_latency_us: i64,
};

/// 
pub const LoadBalance = struct {
    stage_loads: std.StringHashMap([]const u8),
    imbalance_score: f64,
