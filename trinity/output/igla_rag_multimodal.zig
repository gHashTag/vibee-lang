// ═══════════════════════════════════════════════════════════════════════════════
// igla_rag_multimodal v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const MultimodalEmbedding = struct {
    ...
    code_embedding: []const u8,
    fused_embedding: []const u8,
};

/// 
pub const CodeSearchResult = struct {
    chunk_id: i64,
    code: []const u8,
    language: []const u8,
    score: f64,
