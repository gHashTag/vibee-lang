// ═══════════════════════════════════════════════════════════════════════════════
// igla_scale_million v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ShardConfig = struct {
    num_shards: i64,
    vectors_per_shard: i64,
    replication_factor: i64,
};

/// 
pub const DistributedIndex = struct {
    shards: []const u8,
