// ═══════════════════════════════════════════════════════════════════════════════
// foveated_v2675 v2675.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FoveationRegion = struct {
    center_x: f64,
    center_y: f64,
    inner_radius: f64,
    middle_radius: f64,
...
/// 
pub const FoveationLevel = struct {
    region: []const u8,
...
/// 
pub const FoveatedStats = struct {
    pixels_full_res: i64,
    pixels_reduced: i64,
...
/// 
pub const FoveatedConfig = struct {
