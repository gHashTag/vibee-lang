// ═══════════════════════════════════════════════════════════════════════════════
// fractal_core_v628 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FractalStructure = struct {
    root: []const u8,
    depth: i64,
    total_nodes: i64,
    dimension: f64,
...
/// 
pub const FractalMetrics = struct {
