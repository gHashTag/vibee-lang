// ═══════════════════════════════════════════════════════════════════════════════
// browser_coverage_v2279 v2279.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const CoverageReport = struct {
    js_coverage: []const u8,
    css_coverage: []const u8,
    total_bytes: i64,
    used_bytes: i64,
    percentage: f64,
};
...
test "start_js_coverage" {
// Given: Page loaded
// When: JS coverage started
// Then: Coverage collection begins
// Test case: input={ reset_on_navigation: true }, expected={ started: true }
}

test "start_css_coverage" {
// Given: Page loaded
// When: CSS coverage started
// Then: CSS coverage collection begins
// Test case: input={}, expected={ started: true }
}
...
// Test case: input={}, expected={ data_returned: true }
}
...
// Test case: input={ total: 1000, used: 750 }, expected={ percentage: 75.0 }
}
