// ═══════════════════════════════════════════════════════════════════════════════
// lazy_init_v580 v580.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const InitDependency = struct {
    dep_id: []const u8,
    source: []const u8,
    target: []const u8,
    required: bool,
...
/// 
pub const InitMetrics = struct {
    lazy_inits: i64,
    eager_inits: i64,
    init_time_saved_ms: i64,
    phi_efficiency: f64,
};
