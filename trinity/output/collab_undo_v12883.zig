// ═══════════════════════════════════════════════════════════════════════════════
// collab_undo_v12883 v12883.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const UndoManager = struct {
    manager_id: []const u8,
    stacks: []const u8,
    global_history: []const u8,
};

/// 
pub const UndoConfig = struct {
    max_history: i64,
    group_timeout_ms: i64,
    selective_undo: bool,
};

/// 
pub const UndoMetrics = struct {
    undos_performed: i64,
    redos_performed: i64,
