// ═══════════════════════════════════════════════════════════════════════════════
// onnx_export v8.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ExportConfig = struct {
    opset_version: i64,
    dynamic_axes: std.StringHashMap([]const u8),
