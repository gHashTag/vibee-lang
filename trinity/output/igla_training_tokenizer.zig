// ═══════════════════════════════════════════════════════════════════════════════
// igla_training_tokenizer v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const TokenizerVocab = struct {
    tokens: []const u8,
    merges: []const u8,
    special_ids: []const u8,
    vocab_size: i64,
};

/// 
pub const TokenizedText = struct {
    input_ids: []const u8,
...
/// 
pub const TokenizerMetrics = struct {
    compression_ratio: f64,
    fertility: f64,
    unk_rate: f64,
    speed_tokens_sec: f64,
};
