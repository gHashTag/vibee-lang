// ═══════════════════════════════════════════════════════════════════════════════
// igla_v5_flash_decode v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FlashDecodeConfig = struct {
    split_k: i64,
    num_splits: i64,
    softmax_scale: f64,
};
