// ═══════════════════════════════════════════════════════════════════════════════
// neural_liquid_v638 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const LiquidState = struct {
    spike_pattern: []const u8,
    liquid_activity: f64,
    fading_memory: f64,
};

/// 
pub const LiquidReadout = struct {
    weights: []const u8,
    threshold: f64,
    trained: bool,
};
...
/// 
pub const LiquidMetrics = struct {
    separation_property: f64,
    approximation_property: f64,
    fading_memory: f64,
