// ═══════════════════════════════════════════════════════════════════════════════
// igla_competitor_codellama v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CodeLlamaConfig = struct {
    model_size: []const u8,
...
/// 
pub const CodeLlamaBenchmark = struct {
...
/// 
pub const CodeLlamaCapabilities = struct {
    python: f64,
    infilling: f64,
    instruction: f64,
    context_length: i64,
...
/// 
pub const CodeLlamaComparison = struct {
    humaneval: f64,
    mbpp: f64,
    multipl_e: f64,
    infilling: f64,
...
test "load_codellama_benchmarks" {
