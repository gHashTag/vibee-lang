// ═══════════════════════════════════════════════════════════════════════════════
// browser_lora_adapter_v12899 v12899.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const AdapterResult = struct {
    base_output: []const u8,
    lora_output: []const u8,
    merged_output: []const u8,
};

/// 
pub const LoRAMetrics = struct {
    params_percent: f64,
    memory_overhead_mb: f64,
    inference_overhead_ms: f64,
};
