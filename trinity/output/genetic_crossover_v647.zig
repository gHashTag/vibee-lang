// ═══════════════════════════════════════════════════════════════════════════════
// genetic_crossover_v647 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CrossoverType = struct {
    name: []const u8,
    num_points: i64,
    probability: f64,
};
...
/// 
pub const CrossoverResult = struct {
    offspring1: []const u8,
    offspring2: []const u8,
    crossover_points: []const u8,
    success: bool,
};

/// 
pub const CrossoverConfig = struct {
    crossover_rate: f64,
    preserve_best: bool,
    adaptive: bool,
};
...
pub const CrossoverMetrics = struct {
    total_crossovers: i64,
    successful: i64,
    offspring_fitness_avg: f64,
    diversity_change: f64,
};
