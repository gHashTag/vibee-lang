// ═══════════════════════════════════════════════════════════════════════════════
// value_aligned_loss v6.5.2 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ValueLossConfig = struct {
    task_loss_weight: f64,
    value_loss_weight: f64,
    harm_penalty_weight: f64,
};

/// 
pub const ValueLoss = struct {
    task_loss: f64,
    value_alignment_loss: f64,
    harm_penalty: f64,
    total_loss: f64,
};
