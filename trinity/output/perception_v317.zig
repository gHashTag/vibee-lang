// ═══════════════════════════════════════════════════════════════════════════════
// perception v3.1.7 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
test "process_pointcloud" {
// Given: Raw point cloud
// When: Processing
// Then: Filter and segment
// Test case: input='{"pointcloud": {...}}', expected='{"processed": {...}}'
}
...
// When: Detection
// Then: Detect objects
// Test case: input='{"pointcloud": {...}}', expected='{"objects": [...]}'
}
...
// Test case: input='{"object": {...}, "model": {...}}', expected='{"pose": [...]}'
}
...
// Test case: input='{"sensors": [...]}', expected='{"fused": {...}}'
}
...
// Test case: input='{"observations": [...]}', expected='{"model": {...}}'
}
