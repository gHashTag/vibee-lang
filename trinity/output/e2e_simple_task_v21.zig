// ═══════════════════════════════════════════════════════════════════════════════
// e2e_simple_task_v21 v21.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SimpleTaskConfig = struct {
    target_url: []const u8,
    expected_title_contains: []const u8,
    timeout_ms: i64,
};

/// 
pub const SimpleTaskResult = struct {
    success: bool,
