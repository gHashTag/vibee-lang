// ═══════════════════════════════════════════════════════════════════════════════
// offscreen_canvas_v2649 v2649.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const OffscreenStats = struct {
    frames_rendered: i64,
    avg_render_time_ms: f64,
    transfer_overhead_ms: f64,
