// ═══════════════════════════════════════════════════════════════════════════════
// paper_rotary_embed_v662 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const RoPEOutput = struct {
    rotated_query: []const u8,
    rotated_key: []const u8,
    relative_position_encoded: bool,
};

/// 
pub const RoPEMetrics = struct {
    max_extrapolation: i64,
    quality_at_extrapolation: f64,
