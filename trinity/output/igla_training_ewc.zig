// ═══════════════════════════════════════════════════════════════════════════════
// igla_training_ewc v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const FisherInformation = struct {
    param_name: []const u8,
    fisher_diag: []const u8,
    optimal_params: []const u8,
};

/// 
pub const EWCState = struct {
    task_id: i64,
    fisher_matrices: []const u8,
    importance_weights: []const u8,
};

/// 
pub const EWCMetrics = struct {
    forgetting_rate: f64,
    transfer_score: f64,
    ewc_loss: f64,
    task_accuracy: []const u8,
};
