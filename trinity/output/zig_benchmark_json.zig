// ═══════════════════════════════════════════════════════════════════════════════
// zig_benchmark_json v12.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const JsonBenchConfig = struct {
    json_data: []const u8,
    iterations: i64,
    warmup: i64,
};
...
/// 
pub const JsonBenchResult = struct {
...
/// 
pub const ParserComparison = struct {
    simd_result: []const u8,
    std_result: []const u8,
    speedup: f64,
};
