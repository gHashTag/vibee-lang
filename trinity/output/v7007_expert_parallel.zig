// ═══════════════════════════════════════════════════════════════════════════════
// expert_parallel v7.0.7 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ExpertAssignment = struct {
    expert_ids: []const u8,
    token_indices: []const u8,
};

/// 
pub const LoadBalance = struct {
    expert_loads: []const u8,
    aux_loss: f64,
};
