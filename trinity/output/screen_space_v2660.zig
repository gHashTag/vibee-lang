// ═══════════════════════════════════════════════════════════════════════════════
// screen_space_v2660 v2660.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ScreenSpaceStats = struct {
    ssao_ms: f64,
    ssr_ms: f64,
    sss_ms: f64,
    total_ms: f64,
...
/// 
pub const EffectQuality = struct {
    preset: []const u8,
    half_res: bool,
    temporal: bool,
};
