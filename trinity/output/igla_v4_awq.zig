// ═══════════════════════════════════════════════════════════════════════════════
// igla_v4_awq v4.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SalientChannels = struct {
...
/// 
pub const AWQScale = struct {
    scale_per_channel: []const u8,
    optimal_s: f64,
};
