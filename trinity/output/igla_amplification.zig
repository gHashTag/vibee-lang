// ═══════════════════════════════════════════════════════════════════════════════
// igla_amplification v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AmplificationLevel = struct {
    level: i64,
    multiplier: f64,
    agents_active: i64,
};
...
/// 
pub const TrinityPattern = struct {
    agent_1: []const u8,
    agent_2: []const u8,
    agent_3: []const u8,
    synergy_bonus: f64,
