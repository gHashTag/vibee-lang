// ═══════════════════════════════════════════════════════════════════════════════
// cli_commands v2.8.1 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"name": "gen", "category": "codegen"}', expected='{"registered": true}'
}
...
// Test case: input='{"name": "gen"}', expected='{"found": true}'
}
...
// Test case: input='{"category": "core"}', expected='{"commands": [...]}'
}
...
// Test case: input='{"name": "gen"}', expected='{"help": {...}}'
}
...
// Test case: input='{"command": "gen", "args": ["file.vibee"]}', expected='{"valid": true}'
}
...
// Test case: input='{"name": "gen"}', expected='{"stats": {...}}'
}
