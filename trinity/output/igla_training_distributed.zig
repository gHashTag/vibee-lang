// ═══════════════════════════════════════════════════════════════════════════════
// igla_training_distributed v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ShardingStrategy = struct {
    shard_type: []const u8,
    cpu_offload: bool,
