// ═══════════════════════════════════════════════════════════════════════════════
// igla_gpu_diskann v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const GPUSearchResult = struct {
    ids: []const u8,
    distances: []const u8,
    k: i64,
};
