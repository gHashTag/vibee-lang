// ═══════════════════════════════════════════════════════════════════════════════
// igla_v7_mod_v2 v7.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MoDv2Router = struct {
    router_weights: []const u8,
    top_k: i64,
};

/// 
pub const MoDv2Stats = struct {
