// ═══════════════════════════════════════════════════════════════════════════════
// vibee_codegen_v22 v22.4.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CodegenOutput = struct {
    code: []const u8,
    tests: []const u8,
    imports: []const u8,
...
/// 
pub const GeneratedStruct = struct {
    name: []const u8,
    fields: []const u8,
    methods: []const u8,
};
