// ═══════════════════════════════════════════════════════════════════════════════
// igla_koshey_recursive_enhance v8.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const EnhancementConfig = struct {
    target_component: []const u8,
    enhancement_type: []const u8,
    max_iterations: i64,
    convergence_threshold: f64,
};

/// 
pub const EnhancementState = struct {
    iteration: i64,
...
/// 
pub const CodeModification = struct {
    original_code: []const u8,
    modified_code: []const u8,
    modification_type: []const u8,
    expected_improvement: f64,
};

/// 
pub const EnhancementMetrics = struct {
