// ═══════════════════════════════════════════════════════════════════════════════
// multi_agent_systems v5.4.2 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CollaborationProtocol = struct {
    protocol_type: []const u8,
    rules: []const u8,
};

/// 
pub const TeamOutput = struct {
    result: []const u8,
    contributions: std.StringHashMap([]const u8),
};
