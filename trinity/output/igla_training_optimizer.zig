// ═══════════════════════════════════════════════════════════════════════════════
// igla_training_optimizer v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const OptimizerUpdate = struct {
    param_update: []const u8,
    grad_norm: f64,
    lr_used: f64,
};
