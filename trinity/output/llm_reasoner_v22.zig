// ═══════════════════════════════════════════════════════════════════════════════
// llm_reasoner_v22 v22.3.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ReasonerConfig = struct {
    model: []const u8,
    max_tokens: i64,
    temperature: f64,
...
pub const ReasoningOutput = struct {
    ...
    confidence: f64,
    reasoning_steps: []const u8,
};

/// 
pub const ReasonerMetrics = struct {
    total_calls: i64,
    avg_latency_ms: f64,
    total_tokens: i64,
    error_count: i64,
