// ═══════════════════════════════════════════════════════════════════════════════
// meta_learning_v12630 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MetaAlgorithm = struct {
    maml: []const u8,
    prototypical: []const u8,
    matching: []const u8,
    reptile: []const u8,
};
...
/// 
pub const MetaTrainingState = struct {
    learner_id: []const u8,
    meta_iterations: i64,
    avg_query_accuracy: f64,
    tasks_seen: i64,
};
