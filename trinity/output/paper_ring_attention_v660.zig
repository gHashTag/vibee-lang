// ═══════════════════════════════════════════════════════════════════════════════
// paper_ring_attention_v660 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const RingState = struct {
    local_kv: []const u8,
    accumulated_output: []const u8,
    ring_position: i64,
};

/// 
pub const BlockAttention = struct {
    query_block: []const u8,
    key_block: []const u8,
    value_block: []const u8,
    attention_scores: []const u8,
};

/// 
pub const RingMetrics = struct {
    max_sequence_length: i64,
    memory_per_device: i64,
