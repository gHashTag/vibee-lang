// ═══════════════════════════════════════════════════════════════════════════════
// e2e_browser_v525 v525.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const BrowserE2ETest = struct {
    test_id: []const u8,
    name: []const u8,
...
/// 
pub const BrowserTestStep = struct {
    step_id: []const u8,
    action: []const u8,
    target: ?[]const u8,
    value: ?[]const u8,
...
/// 
pub const BrowserTestReport = struct {
    suite_id: []const u8,
    total_tests: i64,
    passed: i64,
    failed: i64,
