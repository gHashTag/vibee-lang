// ═══════════════════════════════════════════════════════════════════════════════
// uncertainty_v13830 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const UncertaintyType = struct {
    aleatoric: []const u8,
    epistemic: []const u8,
    total: []const u8,
    distributional: []const u8,
};
...
/// 
pub const CalibrationMetric = struct {
    ece: f64,
    mce: f64,
    brier_score: f64,
};
...
// Then: Returns aleatoric and epistemic
    // TODO: Add test assertions
}
...
// Then: Returns calibration metric
    // TODO: Add test assertions
}
