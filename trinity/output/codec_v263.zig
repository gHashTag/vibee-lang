// ═══════════════════════════════════════════════════════════════════════════════
// codec v2.6.3 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"config": {...}}', expected='{"encoder_id": 1}'
}
...
// Test case: input='{"codec": "opus"}', expected='{"decoder_id": 1}'
}
...
// Test case: input='{"samples": [...]}', expected='{"frame": {...}}'
}
...
// Test case: input='{"frame": {...}}', expected='{"samples": [...]}'
}
...
// When: Resampling
// Then: Resample audio
// Test case: input='{"samples": [...], "target_rate": 48000}', expected='{"resampled": [...]}'
}
...
// Test case: input='{"samples": [...], "target": "i16"}', expected='{"converted": [...]}'
}
