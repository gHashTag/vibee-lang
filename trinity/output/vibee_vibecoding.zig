// ═══════════════════════════════════════════════════════════════════════════════
// vibee_vibecoding v1.1.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const VibecodeRequest = struct {
    prompt: []const u8,
    context: ?[]const u8,
    language: []const u8,
    file_path: ?[]const u8,
...
/// 
pub const VibecodeResponse = struct {
    code: []const u8,
