// ═══════════════════════════════════════════════════════════════════════════════
// tree_amplification_v677 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AmplificationNode = struct {
    id: []const u8,
    name: []const u8,
    gain_factor: f64,
    energy_cost: f64,
...
/// 
pub const AmplificationChain = struct {
    nodes: []const u8,
    total_gain: f64,
    efficiency: f64,
};
...
pub const AmplificationTree = struct {
    signal_branch: []const u8,
    cascade_branch: []const u8,
    resonance_branch: []const u8,
};
