// ═══════════════════════════════════════════════════════════════════════════════
// igla_competitor_deepseek v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DeepSeekBenchmark = struct {
...
/// 
pub const DeepSeekCapabilities = struct {
    coding: f64,
    math: f64,
    reasoning: f64,
    context_length: i64,
...
/// 
pub const DeepSeekComparison = struct {
    humaneval: f64,
    mbpp: f64,
    math: f64,
    code_contests: f64,
