// ═══════════════════════════════════════════════════════════════════════════════
// igla_training_data_mixing v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DataMixingConfig = struct {
    domains: []const u8,
    weights: []const u8,
    dynamic_mixing: bool,
    temperature: f64,
...
/// 
pub const MixingStrategy = struct {
...
/// 
pub const DataMixingMetrics = struct {
    domain_losses: []const u8,
    effective_weights: []const u8,
    mixing_entropy: f64,
    balance_score: f64,
};
