// ═══════════════════════════════════════════════════════════════════════════════
// optogenetics_v15260 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const NeuralResponse = struct {
    activation: []const u8,
    inhibition: []const u8,
    timing: f64,
};
...
/// 
pub const OptoConfig = struct {
    opsin_type: []const u8,
    light_source: []const u8,
    fiber_placement: []const u8,
};
