// ═══════════════════════════════════════════════════════════════════════════════
// cdp_network_interceptor_v12355 v12355.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const InterceptionRule = struct {
    rule_id: []const u8,
...
/// 
pub const InterceptionResult = struct {
    intercepted: bool,
    modified_request: []const u8,
