// ═══════════════════════════════════════════════════════════════════════════════
// code_generation_v10850 v10850.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CodeSynthesis = struct {
...
/// 
pub const RefactoringOp = struct {
    op_type: []const u8,
    target: []const u8,
    parameters: []const u8,
    safe: bool,
...
/// 
pub const CodeCompletion = struct {
