// ═══════════════════════════════════════════════════════════════════════════════
// deploy_rollback_v2637 v2637.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RollbackTarget = struct {
    deployment: []const u8,
...
/// 
pub const RollbackHistory = struct {
...
/// 
pub const RollbackStrategy = struct {
    strategy_type: []const u8,
    batch_size: i64,
    pause_between_batches: i64,
...
pub const RollbackResult = struct {
    success: bool,
    version_deployed: []const u8,
    instances_updated: i64,
    errors: []const u8,
};
