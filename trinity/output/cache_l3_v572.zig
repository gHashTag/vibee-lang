// ═══════════════════════════════════════════════════════════════════════════════
// cache_l3_v572 v572.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const L3Slice = struct {
    slice_id: []const u8,
    size_mb: i64,
    local_cores: []const u8,
    remote_latency_ns: i64,
};

/// 
pub const L3Metrics = struct {
    hits: i64,
    misses: i64,
    hit_rate: f64,
    avg_latency_ns: f64,
