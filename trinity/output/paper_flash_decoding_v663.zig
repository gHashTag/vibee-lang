// ═══════════════════════════════════════════════════════════════════════════════
// paper_flash_decoding_v663 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FlashDecodingConfig = struct {
    num_splits: i64,
    block_size: i64,
...
/// 
pub const SplitAttention = struct {
...
/// 
pub const FlashDecodingResult = struct {
    output: []const u8,
    total_time_ms: f64,
...
/// 
pub const FlashDecodingMetrics = struct {
