// ═══════════════════════════════════════════════════════════════════════════════
// ai_provider v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
test "provider_detection" {
// Given: Environment variables
// When: AIClient initializes
// Then: Detect available provider (anthropic > openai > ollama > local)
// Test case: input=env: { ANTHROPIC_API_KEY: "sk-ant-xxx" }, expected=
// Test case: input=env: { OLLAMA_HOST: "localhost:11434" }, expected=
