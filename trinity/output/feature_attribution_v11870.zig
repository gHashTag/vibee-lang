// ═══════════════════════════════════════════════════════════════════════════════
// feature_attribution_v11870 v11870 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AttributionMethod = struct {
};

/// 
pub const BaselineType = struct {
};
...
pub const AttributionSummary = struct {
    global_importance: []const u8,
    interaction_effects: []const u8,
    main_effects: []const u8,
};
