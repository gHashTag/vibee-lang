// ═══════════════════════════════════════════════════════════════════════════════
// fairness_metrics_v11920 v11920 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FairnessScore = struct {
    metric: []const u8,
    score: f64,
    group_scores: []const u8,
    is_fair: bool,
};

/// 
pub const FairnessReport = struct {
    overall_fairness: f64,
    metric_scores: []const u8,
    violations: []const u8,
...
test "compute_demographic_parity" {
