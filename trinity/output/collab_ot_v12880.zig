// ═══════════════════════════════════════════════════════════════════════════════
// collab_ot_v12880 v12880.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const OTTransform = struct {
    original_op: []const u8,
    concurrent_op: []const u8,
    transformed_op: []const u8,
};
...
pub const OTState = struct {
    ...
    acknowledged_ops: []const u8,
};

/// 
pub const OTMetrics = struct {
