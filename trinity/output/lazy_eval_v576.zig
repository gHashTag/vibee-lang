// ═══════════════════════════════════════════════════════════════════════════════
// lazy_eval_v576 v576.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const LazyValue = struct {
    ...
    thunk: []const u8,
    evaluated: bool,
    cached_result: ?[]const u8,
    phi_priority: f64,
};

/// 
pub const LazyExpression = struct {
    expr_id: []const u8,
...
/// 
pub const EvaluationGraph = struct {
    graph_id: []const u8,
    nodes: []const u8,
    edges: []const u8,
    evaluation_order: []const u8,
};

/// 
pub const LazyMetrics = struct {
    thunks_created: i64,
    evaluations_forced: i64,
    cache_hits: i64,
    phi_savings: f64,
};
