// ═══════════════════════════════════════════════════════════════════════════════
// interop_callbacks_v56120 v56.1.20 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const CallbackSignature = struct {
    name: []const u8,
...
/// 
pub const CallbackError = struct {
    code: i64,
    message: []const u8,
...
/// 
pub const TrampolineCode = struct {
