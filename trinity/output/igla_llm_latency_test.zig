// ═══════════════════════════════════════════════════════════════════════════════
// igla_llm_latency_test v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const LatencyConfig = struct {
    request_sizes: []const u8,
    response_sizes: []const u8,
    warmup_requests: i64,
    measurement_requests: i64,
};

/// 
pub const LatencyTask = struct {
    task_id: []const u8,
    input_tokens: i64,
    output_tokens: i64,
    streaming: bool,
