// ═══════════════════════════════════════════════════════════════════════════════
// neural_echo_v639 v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const EchoConfig = struct {
    reservoir_size: i64,
    spectral_radius: f64,
    input_scaling: f64,
    feedback_scaling: f64,
};

/// 
pub const EchoState = struct {
    internal_state: []const u8,
    echo_strength: f64,
