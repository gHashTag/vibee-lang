// ═══════════════════════════════════════════════════════════════════════════════
// input_validation_v11710 v11710 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ValidationLevel = struct {
};
...
pub const ValidationResult = struct {
    is_valid: bool,
    anomaly_score: f64,
    sanitized_input: []const u8,
    rejection_reason: []const u8,
};

/// 
pub const InputConstraint = struct {
