// ═══════════════════════════════════════════════════════════════════════════════
// igla_rag_retriever v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RetrievedDocument = struct {
    id: []const u8,
    text: []const u8,
    score: f64,
    source: []const u8,
...
/// 
pub const RetrieverMetrics = struct {
    queries_total: i64,
    avg_latency_ms: f64,
    avg_docs_returned: f64,
    cache_hit_rate: f64,
};
