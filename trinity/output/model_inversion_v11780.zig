// ═══════════════════════════════════════════════════════════════════════════════
// model_inversion_v11780 v11780 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const DefenseConfig = struct {
    ...
    output_perturbation: f64,
    confidence_masking: bool,
    rate_limiting: bool,
};

/// 
pub const InversionDefense = struct {
};

/// 
pub const InversionAttempt = struct {
...
/// 
pub const DefenseResult = struct {
    original_output: []const u8,
    defended_output: []const u8,
    utility_loss: f64,
    privacy_gain: f64,
};
...
test "apply_output_perturbation" {
// Given: Model output
// When: 
