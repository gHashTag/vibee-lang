// ═══════════════════════════════════════════════════════════════════════════════
// perf_quantization_v2745 v2745.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const QuantizeRequest = struct {
    model_path: []const u8,
    target_bits: i64,
    method: []const u8,
};
...
/// 
pub const QuantizeMethod = struct {
