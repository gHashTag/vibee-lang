// ═══════════════════════════════════════════════════════════════════════════════
// adversarial_training_v11720 v11720 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const TrainingResult = struct {
    final_clean_acc: f64,
    final_robust_acc: f64,
    training_time: i64,
    model_checkpoint: []const u8,
};
...
test "generate_training_adversarials" {
// Given: Batch
// When: 
