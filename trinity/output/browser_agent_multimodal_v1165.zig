// ═══════════════════════════════════════════════════════════════════════════════
// browser_agent_multimodal_v1165 v12.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MultimodalContext = struct {
    text: []const u8,
    images: []const u8,
    audio: []const u8,
    video_frames: []const u8,
};

/// 
pub const ModalityBinding = struct {
