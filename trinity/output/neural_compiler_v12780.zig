// ═══════════════════════════════════════════════════════════════════════════════
// neural_compiler_v12780 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const OptimizationPass = struct {
    loop_unrolling: []const u8,
    vectorization: []const u8,
    inlining: []const u8,
...
/// 
pub const NeuralOptimizer = struct {
    id: []const u8,
    model: []const u8,
...
pub const PerformanceModel = struct {
    ...
    latency_predictor: []const u8,
    throughput_predictor: []const u8,
};
