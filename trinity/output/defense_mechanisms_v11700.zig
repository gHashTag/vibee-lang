// ═══════════════════════════════════════════════════════════════════════════════
// defense_mechanisms_v11700 v11700 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const DefenseType = struct {
};

/// 
pub const DefenseResult = struct {
    input_defended: bool,
    defense_applied: []const u8,
