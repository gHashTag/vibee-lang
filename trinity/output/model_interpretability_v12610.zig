// ═══════════════════════════════════════════════════════════════════════════════
// model_interpretability_v12610 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const AttentionVisualization = struct {
    layer_name: []const u8,
...
pub const Counterfactual = struct {
    ...
    modified_input: []const u8,
    original_prediction: []const u8,
