// ═══════════════════════════════════════════════════════════════════════════════
// zig_cdp_protocol v14.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const PageNavigateParams = struct {
    url: []const u8,
    referrer: ?[]const u8,
...
/// 
pub const PageNavigateResult = struct {
    frame_id: []const u8,
    loader_id: ?[]const u8,
    error_text: ?[]const u8,
};
...
/// 
pub const RuntimeEvaluateParams = struct {
    expression: []const u8,
...
/// 
pub const RuntimeEvaluateResult = struct {
