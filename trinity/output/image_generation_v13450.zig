// ═══════════════════════════════════════════════════════════════════════════════
// image_generation_v13450 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const GenerationModel = struct {
    stable_diffusion: []const u8,
    dalle: []const u8,
    midjourney: []const u8,
    imagen: []const u8,
};
...
/// 
pub const GenerationPrompt = struct {
    positive: []const u8,
    negative: []const u8,
    guidance_scale: f64,
    num_steps: i64,
