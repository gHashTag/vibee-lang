// ═══════════════════════════════════════════════════════════════════════════════
// browser_glass_vibrancy_v1168 v12.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const VibrancyEffect = struct {
    material: []const u8,
    blend_mode: []const u8,
    behind_window: bool,
};
...
/// 
pub const SystemAppearance = struct {
    dark_mode: bool,
...
/// 
pub const VibrancyLayer = struct {
    id: []const u8,
    material: []const u8,
    bounds: []const u8,
    z_index: i64,
