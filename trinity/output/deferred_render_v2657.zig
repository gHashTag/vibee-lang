// ═══════════════════════════════════════════════════════════════════════════════
// deferred_render_v2657 v2657.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const GBufferConfig = struct {
    width: i64,
    height: i64,
    hdr: bool,
    precision: []const u8,
...
pub const DeferredStats = struct {
    gbuffer_fill_ms: f64,
    lighting_pass_ms: f64,
    lights_processed: i64,
    overdraw: f64,
};
