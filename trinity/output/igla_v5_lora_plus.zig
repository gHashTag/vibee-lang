// ═══════════════════════════════════════════════════════════════════════════════
// igla_v5_lora_plus v5.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const LoraPlusConfig = struct {
    rank: i64,
    alpha: f64,
    lr_ratio: f64,
};
...
/// 
pub const LoraPlusLayer = struct {
    lora_A: []const u8,
    lora_B: []const u8,
    lr_A: f64,
    lr_B: f64,
...
/// 
pub const LoraPlusStats = struct {
    accuracy_gain: f64,
