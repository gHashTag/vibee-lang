// ═══════════════════════════════════════════════════════════════════════════════
// kinematics v3.1.3 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"angles": [0, 0, 0, 0, 0, 0]}', expected='{"pose": {...}}'
}
...
// Test case: input='{"pose": {...}}', expected='{"angles": [...]}'
}
...
// Test case: input='{"angles": [...]}', expected='{"jacobian": {...}}'
}

test "velocity_kinematics" {
// Given: Joint velocities
// When: Velocity computation
// Then: Compute end effector velocity
// Test case: input='{"velocities": [...]}', expected='{"ee_velocity": [...]}'
}

test "check_singularity" {
// Given: Jacobian
// When: Singularity check
// Then: Check for singularity
// Test case: input='{"jacobian": {...}}', expected='{"singular": false}'
}

test "workspace_analysis" {
// Given: Robot chain
// When: Workspace analysis
// Then: Compute workspace
// Test case: input='{"chain": {...}}', expected='{"volume": 1.5}'
}
