// ═══════════════════════════════════════════════════════════════════════════════
// e2e_chat_tests_v12401 v12401.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ChatTestMessage = struct {
    role: []const u8,
    content: []const u8,
...
/// 
pub const ChatTestAssertion = struct {
    response_contains: []const u8,
    code_block_language: []const u8,
