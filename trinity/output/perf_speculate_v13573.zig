// ═══════════════════════════════════════════════════════════════════════════════
// perf_speculate v13573 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const SpeculativeConfig = struct {
    max_speculation_depth: i64,
    rollback_enabled: bool,
    prediction_threshold: f64,
};

/// 
pub const SpeculativePath = struct {
    path_id: []const u8,
    prediction: []const u8,
    confidence: f64,
    result: []const u8,
...
pub const SpeculativeState = struct {
    active_paths: i64,
    committed_paths: i64,
    rolled_back_paths: i64,
};

/// 
pub const BranchPrediction = struct {
    branch_id: []const u8,
    predicted_direction: []const u8,
    actual_direction: []const u8,
    correct: bool,
};

/// 
pub const SpeculativeMetrics = struct {
    predictions_total: i64,
    predictions_correct: i64,
    accuracy: f64,
    speedup: f64,
};
