// ═══════════════════════════════════════════════════════════════════════════════
// sensor_fusion_v12970 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FusionAlgorithm = struct {
    kalman: []const u8,
