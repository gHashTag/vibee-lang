// ═══════════════════════════════════════════════════════════════════════════════
// llm_provider_openai v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const OpenAIEmbeddingResponse = struct {
    embedding: []const u8,
    index: i64,
    usage_tokens: i64,
};
...
test "create_streaming_completion" {
