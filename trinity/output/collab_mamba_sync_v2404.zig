// ═══════════════════════════════════════════════════════════════════════════════
// collab_mamba_sync_v2404 v2404.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MambaSyncConfig = struct {
...
pub const SyncState = struct {
    ...
    remote_states: []const u8,
    mamba_predicted_ops: []const u8,
    merge_pending: bool,
};
