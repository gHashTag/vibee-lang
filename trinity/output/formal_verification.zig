...
pub const CompetitorVerification = struct {
    ...
    pub fn trinityVsOpenSSL() i8 {
        return @as(i8, @intCast(TRINITY_LEVEL.securityLevel())) - @as(i8, @intCast(OPENSSL_LEVEL.securityLevel()));
    }

    pub fn trinityVsLibsodium() i8 {
        return @as(i8, @intCast(TRINITY_LEVEL.securityLevel())) - @as(i8, @intCast(LIBSODIUM_LEVEL.securityLevel()));
    }
};
