// ═══════════════════════════════════════════════════════════════════════════════
// pipeline_fusion_v562 v562.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const StageFusion = struct {
    fusion_id: []const u8,
    fused_stages: []const u8,
...
/// 
pub const FusedStage = struct {
    stage_id: []const u8,
    original_stages: []const u8,
    combined_transform: []const u8,
    memory_savings: i64,
};
