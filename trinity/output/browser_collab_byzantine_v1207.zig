// ═══════════════════════════════════════════════════════════════════════════════
// browser_collab_byzantine_v1207 v13.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const BFTConfig = struct {
    total_nodes: i64,
    faulty_threshold: i64,
    signature_scheme: []const u8,
};

/// 
pub const SignedOperation = struct {
    operation: []const u8,
    signature: []const u8,
    public_key: []const u8,
    timestamp: i64,
...
/// 
pub const ByzantineProof = struct {
