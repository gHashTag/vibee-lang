// ═══════════════════════════════════════════════════════════════════════════════
// igla_serve_openai v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const OpenAICompletionRequest = struct {
    model: []const u8,
    prompt: []const u8,
    max_tokens: i64,
    temperature: f64,
...
/// 
pub const OpenAICompletionResponse = struct {
    id: []const u8,
    object: []const u8,
    created: i64,
    model: []const u8,
...
test "format_completion_response" {
