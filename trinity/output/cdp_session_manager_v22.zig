// ═══════════════════════════════════════════════════════════════════════════════
// cdp_session_manager_v22 v22.1.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const PageLoadResult = struct {
    success: bool,
    url: []const u8,
    title: []const u8,
    load_time_ms: i64,
