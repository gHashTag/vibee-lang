// ═══════════════════════════════════════════════════════════════════════════════
// threat_modeling_v11650 v11650 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ThreatConfig = struct {
    model_type: ThreatModelType,
    attack_surface: []const u8,
    threat_actors: []const u8,
    risk_tolerance: f64,
};

/// 
pub const ThreatModelType = struct {
};
...
/// 
pub const ThreatCategory = struct {
};

/// 
pub const RiskAssessment = struct {
    total_risk: f64,
    critical_threats: []const u8,
