// ═══════════════════════════════════════════════════════════════════════════════
// present_wait_v2679 v2679.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const PresentConfig = struct {
    wait_for_present: bool,
    max_frame_latency: i64,
    allow_tearing: bool,
    sync_interval: i64,
};
...
pub const FrameStatistics = struct {
    present_count: i64,
    present_refresh_count: i64,
    sync_refresh_count: i64,
    glitch_count: i64,
};
