// ═══════════════════════════════════════════════════════════════════════════════
// cdp_screenshot v13598 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ScreenshotClip = struct {
    x: f64,
    y: f64,
    width: f64,
    height: f64,
...
/// 
pub const ScreencastConfig = struct {
    format: []const u8,
    quality: i64,
    max_width: i64,
    max_height: i64,
...
/// 
pub const ScreenshotMetrics = struct {
