// ═══════════════════════════════════════════════════════════════════════════════
// reprojection_v2676 v2676.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ReprojectionConfig = struct {
    mode: []const u8,
    motion_vectors: bool,
    depth_based: bool,
    extrapolation: bool,
...
/// 
pub const ReprojectedFrame = struct {
    color: []const u8,
    confidence: []const u8,
    holes_mask: []const u8,
...
/// 
pub const ReprojectionStats = struct {
    frames_reprojected: i64,
    avg_quality: f64,
    holes_percent: f64,
...
/// 
pub const HoleFillConfig = struct {
    method: []const u8,
    search_radius: i64,
    temporal_blend: f64,
};
