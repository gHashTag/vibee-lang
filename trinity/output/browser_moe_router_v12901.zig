// ═══════════════════════════════════════════════════════════════════════════════
// browser_moe_router_v12901 v12901.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const RoutingDecision = struct {
    token_id: i64,
    selected_experts: []const u8,
    routing_weights: []const u8,
};
...
/// 
pub const MoEMetrics = struct {
    expert_utilization: []const u8,
    routing_entropy: f64,
