// ═══════════════════════════════════════════════════════════════════════════════
// gradient_checkpointing_v2101 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const CheckpointConfig = struct {
    ...
    selective_layers: []const u8,
    memory_budget: i64,
};

/// 
pub const CheckpointStrategy = struct {
    strategy_type: []const u8,
    recompute_granularity: []const u8,
    memory_savings: f64,
};
