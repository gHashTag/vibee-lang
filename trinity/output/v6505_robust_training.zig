// ═══════════════════════════════════════════════════════════════════════════════
// robust_training v6.5.5 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RobustnessMetrics = struct {
    clean_accuracy: f64,
    robust_accuracy: f64,
...
test "detect_distribution_shift" {
