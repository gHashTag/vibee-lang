// ═══════════════════════════════════════════════════════════════════════════════
// warp_agent_reflexion v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ReflexionState = struct {
    current_trial: i64,
    max_trials: i64,
    memories: []const u8,
    best_score: f64,
...
/// 
pub const ReflexionResult = struct {
    success: bool,
    trials_used: i64,
    final_score: f64,
    learned_lessons: []const u8,
};
