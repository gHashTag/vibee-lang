// ═══════════════════════════════════════════════════════════════════════════════
// formal_proof v2.3.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"prop": {...}}', expected='{"smt": "..."}'
}
...
// Test case: input='{"query": {...}}', expected='{"sat": false}'
}
...
// Then: Transform goal
// Test case: input='{"goal": {...}, "tactic": "intro"}', expected='{"new_goals": [...]}'
}
...
// Test case: input='{"prop": {...}}', expected='{"status": "proven"}'
}

test "extract_counterexample" {
// Given: SAT model
// When: Counterexample needed
// Then: Generate concrete example
// Test case: input='{"model": {...}}', expected='{"example": {...}}'
}
...
// Test case: input='{"loop": {...}, "inv": {...}}', expected='{"holds": true}'
}
