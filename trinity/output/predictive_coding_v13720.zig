// ═══════════════════════════════════════════════════════════════════════════════
// predictive_coding_v13720 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const PCHierarchy = struct {
    layers: []const u8,
    num_levels: i64,
    top_down_weights: []const u8,
};

/// 
pub const PredictionError = struct {
    error_signal: []const u8,
    magnitude: f64,
    layer_id: i64,
};

/// 
pub const PCUpdate = struct {
    updated_beliefs: []const u8,
    free_energy: f64,
    convergence: bool,
};

/// 
pub const PCConfig = struct {
    num_levels: i64,
    learning_rate: f64,
