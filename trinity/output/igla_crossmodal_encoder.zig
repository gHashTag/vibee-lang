// ═══════════════════════════════════════════════════════════════════════════════
// igla_crossmodal_encoder v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const UnifiedEmbedding = struct {
    vector: []const u8,
    modality: []const u8,
    confidence: f64,
};
...
pub const EncoderOutput = struct {
    embedding: []const u8,
    modality_scores: []const u8,
};

/// 
pub const ModalityAdapter = struct {
    modality: []const u8,
    projection: []const u8,
    input_dim: i64,
    output_dim: i64,
...
/// 
pub const CrossModalStats = struct {
    text_encoded: i64,
    images_encoded: i64,
    code_encoded: i64,
};
