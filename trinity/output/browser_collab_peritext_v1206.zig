// ═══════════════════════════════════════════════════════════════════════════════
// browser_collab_peritext_v1206 v13.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const PeritextDoc = struct {
    content: []const u8,
    marks: []const u8,
    anchors: std.StringHashMap([]const u8),
};

/// 
pub const TextMark = struct {
    @"type": []const u8,
    start_anchor: []const u8,
    end_anchor: []const u8,
...
/// 
pub const FormatOperation = struct {
    mark_type: []const u8,
    range_start: i64,
    range_end: i64,
    add: bool,
