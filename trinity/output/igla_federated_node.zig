// ═══════════════════════════════════════════════════════════════════════════════
// igla_federated_node v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const NodeConfig = struct {
    node_id: i64,
    coordinator_address: []const u8,
    local_index_path: []const u8,
};
...
test "register_with_coordinator" {
