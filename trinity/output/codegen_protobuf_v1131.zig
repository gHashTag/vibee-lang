// ═══════════════════════════════════════════════════════════════════════════════
// codegen_protobuf v11.3.1 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Then: Proto message
// Test case: input='{"type": {"name": "User"}}', expected='{"code": "message User"}'
}
...
// Then: Proto service
// Test case: input='{"behaviors": [...]}', expected='{"code": "service UserService"}'
}
