// ═══════════════════════════════════════════════════════════════════════════════
// planning_backtrack v11.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const BacktrackDecision = struct {
    should_backtrack: bool,
    target_checkpoint: ?[]const u8,
    reason: []const u8,
    alternative_paths: []const u8,
};
