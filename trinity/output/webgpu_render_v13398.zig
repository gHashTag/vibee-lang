// ═══════════════════════════════════════════════════════════════════════════════
// webgpu_render v13398.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const RenderConfig = struct {
    color_format: []const u8,
    depth_format: []const u8,
    sample_count: i64,
...
pub const RenderPass = struct {
    pass_id: []const u8,
    color_attachments: []const u8,
    depth_attachment: []const u8,
};
