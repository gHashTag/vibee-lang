// ═══════════════════════════════════════════════════════════════════════════════
// autoregressive_gen_v13540 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ARModel = struct {
    pixelcnn: []const u8,
    wavenet: []const u8,
    transformer_ar: []const u8,
    mamba_ar: []const u8,
};

/// 
pub const ARContext = struct {
    past_tokens: []const u8,
    context_length: i64,
    cache: []const u8,
};
