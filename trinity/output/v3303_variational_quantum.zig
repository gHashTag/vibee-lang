// ═══════════════════════════════════════════════════════════════════════════════
// variational_quantum v3.3.3 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const VariationalConfig = struct {
    num_qubits: i64,
    num_layers: i64,
    learning_rate: f64,
};
...
/// 
pub const ParameterizedCircuit = struct {
    parameters: []const u8,
    num_params: i64,
};
