// ═══════════════════════════════════════════════════════════════════════════════
// interop_errors_v56180 v56.1.80 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ExceptionInfo = struct {
    type_name: []const u8,
    message: []const u8,
    inner_exception: ?[]const u8,
    stack_trace: []const u8,
};

/// 
pub const ResultType = struct {
    success_type: []const u8,
    error_type: []const u8,
    is_ok: bool,
};
...
/// 
pub const ErrorTranslation = struct {
