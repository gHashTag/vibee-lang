// ═══════════════════════════════════════════════════════════════════════════════
// igla_v6_grouped_gemm v6.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const GroupedGEMMConfig = struct {
    num_groups: i64,
    batch_size: i64,
    fused_ops: bool,
};
...
/// 
pub const GroupedOutput = struct {
    results: []const u8,
    throughput: f64,
    efficiency: f64,
};
