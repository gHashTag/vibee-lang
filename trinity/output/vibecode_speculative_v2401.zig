// ═══════════════════════════════════════════════════════════════════════════════
// vibecode_speculative_v2401 v2401.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SpecCodeConfig = struct {
    draft_model: []const u8,
    target_model: []const u8,
    lookahead_tokens: i64,
    tree_depth: i64,
};

/// 
pub const CodeDraftTree = struct {
    completions: []const u8,
    probabilities: []const u8,
    syntax_valid: []const u8,
    semantic_score: f64,
};

/// 
pub const SpecCodeOutput = struct {
    accepted_code: []const u8,
    acceptance_rate: f64,
