// ═══════════════════════════════════════════════════════════════════════════════
// lazy_load_v579 v579.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const LazyLoader = struct {
    loader_id: []const u8,
    load_strategy: []const u8,
    loaded_items: std.StringHashMap([]const u8),
    phi_priority: bool,
};
...
/// 
pub const LoaderMetrics = struct {
