// ═══════════════════════════════════════════════════════════════════════════════
// codegen_integration_v22 v22.6.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const IntegrationSpec = struct {
    name: []const u8,
    http_endpoints: []const u8,
    ws_handlers: []const u8,
    types: []const u8,
};
...
/// 
pub const IntegrationCodegen = struct {
    http_codegen: []const u8,
    ws_codegen: []const u8,
