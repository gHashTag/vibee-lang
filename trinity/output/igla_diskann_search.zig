// ═══════════════════════════════════════════════════════════════════════════════
// igla_diskann_search v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const BeamState = struct {
    candidates: []const u8,
    visited: []const u8,
    best_so_far: []const u8,
};

/// 
pub const SectorRead = struct {
    sector_id: i64,
    data: []const u8,
    latency_us: f64,
};
