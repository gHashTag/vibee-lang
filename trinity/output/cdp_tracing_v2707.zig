// ═══════════════════════════════════════════════════════════════════════════════
// cdp_tracing_v2707 v2707.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const TraceBuffer = struct {
    events: []const u8,
    stream_compression: []const u8,
    total_size_bytes: i64,
};

/// 
pub const TracingCategories = struct {
    available: []const u8,
    enabled: []const u8,
};
