// ═══════════════════════════════════════════════════════════════════════════════
// igla_model_34b v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const Model34BConfig = struct {
    hidden_size: i64,
    num_layers: i64,
    num_heads: i64,
    num_kv_heads: i64,
...
/// 
pub const Model34BArchitecture = struct {
    params_billions: f64,
    flops_per_token: f64,
    memory_fp16_gb: f64,
    memory_int4_gb: f64,
...
/// 
pub const Model34BTraining = struct {
...
/// 
pub const Model34BMetrics = struct {
    humaneval: f64,
    mmlu: f64,
    gsm8k: f64,
    hellaswag: f64,
