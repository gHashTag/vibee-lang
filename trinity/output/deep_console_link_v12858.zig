// ═══════════════════════════════════════════════════════════════════════════════
// deep_console_link_v12858 v12858.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ConsoleLink = struct {
    link_id: []const u8,
    browser_console: []const u8,
    vscode_terminal: []const u8,
    bidirectional: bool,
};
...
/// 
pub const ConsoleHistory = struct {
    messages: []const u8,
    total_count: i64,
    filtered_count: i64,
};
