// ═══════════════════════════════════════════════════════════════════════════════
// pipeline_backpressure_v561 v561.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const BackpressureController = struct {
    ...
    strategy: []const u8,
    phi_threshold: f64,
    propagation_delay_us: i64,
};

/// 
pub const PressureSignal = struct {
    signal_id: []const u8,
    source_stage: []const u8,
    pressure_level: f64,
    timestamp: i64,
};
