// ═══════════════════════════════════════════════════════════════════════════════
// learning_to_learn_v14240 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MetaOptimizer = struct {
    lstm_optimizer: []const u8,
    learned_lr: []const u8,
    meta_sgd: []const u8,
};
...
/// 
pub const L2LResult = struct {
    final_params: []const u8,
    convergence_steps: i64,
    meta_loss: f64,
};
