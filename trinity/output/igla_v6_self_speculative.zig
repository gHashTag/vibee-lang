// ═══════════════════════════════════════════════════════════════════════════════
// igla_v6_self_speculative v6.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const EarlyExitDraft = struct {
    exit_layer: i64,
...
/// 
pub const SelfVerifyResult = struct {
    accepted: i64,
    rejected: i64,
    speedup: f64,
};
