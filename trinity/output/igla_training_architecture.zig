// ═══════════════════════════════════════════════════════════════════════════════
// igla_training_architecture v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ModelArchitecture = struct {
    embedding: []const u8,
    blocks: []const u8,
    output_head: []const u8,
    total_params: []const u8,
};
