// ═══════════════════════════════════════════════════════════════════════════════
// igla_quantum_optimization v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MixerHamiltonian = struct {
    mixer_type: []const u8,
    parameters: []const u8,
};
...
/// 
pub const VariationalParams = struct {
    gamma: []const u8,
    beta: []const u8,
};
