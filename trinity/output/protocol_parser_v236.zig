// ═══════════════════════════════════════════════════════════════════════════════
// protocol_parser v2.3.6 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
// Test case: input='{"bytes": [...], "field": {...}}', expected='{"value": 42}'
}
...
// Test case: input='{"bytes": [...], "protocol": {...}}', expected='{"parsed": {...}}'
}
...
test "zero_copy_parse" {
// Given: Buffer reference
// When: Zero-copy mode
// Then: Parse without copying
// Test case: input='{"buffer": {...}}', expected='{"parsed": {...}}'
}
...
// Test case: input='{"stream": {...}}', expected='{"messages": [...]}'
}
...
// Test case: input='{"protocol": {...}}', expected='{"parser": {...}}'
}
