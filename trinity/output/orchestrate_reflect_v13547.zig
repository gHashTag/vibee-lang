// ═══════════════════════════════════════════════════════════════════════════════
// orchestrate_reflect v13547 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const ReflectionMetrics = struct {
    reflections_total: i64,
    improvements_identified: i64,
    improvements_applied: i64,
};

/// 
pub const LearningOutcome = struct {
    lesson: []const u8,
    context: []const u8,
