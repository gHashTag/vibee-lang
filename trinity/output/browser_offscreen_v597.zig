// ═══════════════════════════════════════════════════════════════════════════════
// browser_offscreen_v597 v597.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const OffscreenContext = struct {
    context_id: []const u8,
    canvas_id: []const u8,
    context_type: []const u8,
    attributes: []const u8,
...
pub const RenderResult = struct {
    result_id: []const u8,
    image_bitmap: []const u8,
    render_time_us: i64,
};

/// 
pub const OffscreenMetrics = struct {
    frames_rendered: i64,
