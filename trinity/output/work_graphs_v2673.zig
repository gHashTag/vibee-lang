// ═══════════════════════════════════════════════════════════════════════════════
// work_graphs_v2673 v2673.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const WorkNode = struct {
    node_id: []const u8,
    shader: []const u8,
    input_records: []const u8,
    output_records: []const u8,
    max_dispatch: i64,
};

/// 
pub const WorkRecord = struct {
