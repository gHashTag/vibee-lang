// ═══════════════════════════════════════════════════════════════════════════════
// onnx_perf v13540 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const ONNXPerfConfig = struct {
...
/// 
pub const InferenceProfile = struct {
    total_time_ms: f64,
    operator_times: []const u8,
    memory_peak_mb: i64,
...
/// 
pub const ONNXPerfMetrics = struct {
...
/// 
pub const ONNXPerfReport = struct {
    profile: []const u8,
