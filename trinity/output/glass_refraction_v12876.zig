// ═══════════════════════════════════════════════════════════════════════════════
// glass_refraction_v12876 v12876.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const RefractionEffect = struct {
    effect_id: []const u8,
    ior: f64,
    distortion: f64,
...
/// 
pub const RefractionMap = struct {
    map_id: []const u8,
    normal_map: []const u8,
    displacement: f64,
};
...
/// 
pub const RefractionResult = struct {
    texture_id: []const u8,
    render_time_ms: f64,
};

/// 
pub const RefractionMetrics = struct {
