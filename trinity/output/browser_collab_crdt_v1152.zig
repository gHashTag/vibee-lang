// ═══════════════════════════════════════════════════════════════════════════════
// browser_collab_crdt_v1152 v12.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const PNCounter = struct {
    positive: std.StringHashMap([]const u8),
    negative: std.StringHashMap([]const u8),
};
...
pub const ORSet = struct {
    ...
    tombstones: std.StringHashMap([]const u8),
};

/// 
pub const VectorClock = struct {
    clocks: std.StringHashMap([]const u8),
    node_id: []const u8,
};
