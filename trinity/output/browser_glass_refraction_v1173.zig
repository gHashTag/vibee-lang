// ═══════════════════════════════════════════════════════════════════════════════
// browser_glass_refraction_v1173 v12.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const LensDistortion = struct {
    barrel: f64,
    pincushion: f64,
    center: []const u8,
};
...
/// 
pub const CausticEffect = struct {
    intensity: f64,
    pattern: []const u8,
    animated: bool,
};
