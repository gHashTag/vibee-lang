// ═══════════════════════════════════════════════════════════════════════════════
// tinyml_v12960 v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const PowerProfile = struct {
    ...
    active_power_mw: f64,
    sleep_power_uw: f64,
    inference_energy_uj: f64,
};

/// 
pub const TinyInference = struct {
    model_id: []const u8,
    input: []const u8,
    output: []const u8,
    cycles: i64,
