// ═══════════════════════════════════════════════════════════════════════════════
// pipeline_parallel v7.0.3 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const MicrobatchState = struct {
    microbatch_id: i64,
...
pub const Schedule = struct {
    forward_order: []const u8,
    backward_order: []const u8,
};
