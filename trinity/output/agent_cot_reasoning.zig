// ═══════════════════════════════════════════════════════════════════════════════
// agent_cot_reasoning v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const SelfConsistency = struct {
    num_samples: i64,
    temperature: f64,
    voting_method: []const u8,
    final_answer: []const u8,
};

/// 
pub const ReasoningVerification = struct {
    verification_id: []const u8,
    original_chain: []const u8,
...
test "extract_intermediate_results" {
// Given: Reasoning chain
