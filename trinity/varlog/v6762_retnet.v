// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - v6762_retnet v1.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module v6762_retnet (
  ...
  input  wire        rst_n,
  input  wire        enable,
  input  wire [63:0] RetNetConfig_hidden_dim_in,
  output reg  [63:0] RetNetConfig_hidden_dim_out,
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      RetNetConfig_hidden_dim_out <= 64'd0;
      ...
      case (state)
        ...
        PROCESS: begin
          RetNetConfig_hidden_dim_out <= RetNetConfig_hidden_dim_in;
