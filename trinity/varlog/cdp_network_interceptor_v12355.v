// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - cdp_network_interceptor_v12355 v12355.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module cdp_network_interceptor_v12355 (
  ...
  input  wire [255:0] InterceptionRule_rule_id_in,
  output reg  [255:0] InterceptionRule_rule_id_out,
  input  wire [255:0] InterceptionRule_url_pattern_in,
  output reg  [255:0] InterceptionRule_url_pattern_out,
  ...
  input  wire  InterceptionResult_intercepted_in,
  output reg   InterceptionResult_intercepted_out,
  input  wire [31:0] InterceptionResult_modified_request_in,
  output reg  [31:0] InterceptionResult_modified_request_out,
  input  wire [31:0] InterceptionResult_mock_response_in,
  output reg  [31:0] InterceptionResult_mock_response_out,
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      InterceptionRule_rule_id_out <= 256'd0;
      InterceptionRule_url_pattern_out <= 256'd0;
      InterceptionRule_resource_type_out <= 256'd0;
      InterceptionRule_action_out <= 256'd0;
      InterceptionResult_intercepted_out <= 1'b0;
      InterceptionResult_modified_request_out <= 32'd0;
      InterceptionResult_mock_response_out <= 32'd0;
      ...
      case (state)
        ...
        PROCESS: begin
          ...
          InterceptionRule_rule_id_out <= InterceptionRule_rule_id_in;
          InterceptionRule_url_pattern_out <= InterceptionRule_url_pattern_in;
          ...
          InterceptionResult_intercepted_out <= InterceptionResult_intercepted_in;
          InterceptionResult_modified_request_out <= InterceptionResult_modified_request_in;
          InterceptionResult_mock_response_out <= InterceptionResult_mock_response_in;
