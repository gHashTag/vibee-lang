// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - tree_browser_v2525 v2525.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module tree_browser_v2525 (
  ...
  input  wire [255:0] TechTree_completed_nodes_in,
  output reg  [255:0] TechTree_completed_nodes_out,
  input  wire [255:0] ResearchPath_path_name_in,
  output reg  [255:0] ResearchPath_path_name_out,
  input  wire [255:0] ResearchPath_nodes_in,
  output reg  [255:0] ResearchPath_nodes_out,
  input  wire [63:0] ResearchPath_estimated_weeks_in,
  output reg  [63:0] ResearchPath_estimated_weeks_out,
  output reg         done
);
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      TechTree_completed_nodes_out <= 256'd0;
      ResearchPath_path_name_out <= 256'd0;
      ResearchPath_nodes_out <= 256'd0;
      ResearchPath_estimated_weeks_out <= 64'd0;
    end else begin
      case (state)
        ...
        PROCESS: begin
          ...
          TechTree_completed_nodes_out <= TechTree_completed_nodes_in;
          ResearchPath_path_name_out <= ResearchPath_path_name_in;
          ResearchPath_nodes_out <= ResearchPath_nodes_in;
          ResearchPath_estimated_weeks_out <= ResearchPath_estimated_weeks_in;
          state <= DONE;
        end
  ...
  // - unlock_chromium_core
  // - unlock_ai_agent
  // - unlock_collaboration
