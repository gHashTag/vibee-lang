// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - chinese_nlp v9.9.2
// ═══════════════════════════════════════════════════════════════════════════════
...
module chinese_nlp (
  ...
  input  wire [255:0] Entity_pinyin_in,
  output reg  [255:0] Entity_pinyin_out,
    ...
    if (!rst_n) begin
      ...
      case (state)
        ...
        PROCESS: begin
          ...
          Entity_pinyin_out <= Entity_pinyin_in;
