// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - v6746_activation_checkpoint_v2 v1.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module v6746_activation_checkpoint_v2 (
  ...
  input  wire [255:0] CheckpointConfig_recompute_granularity_in,
  output reg  [255:0] CheckpointConfig_recompute_granularity_out,
  output reg         done
);
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      CheckpointConfig_recompute_granularity_out <= 256'd0;
    end else begin
      case (state)
