// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - zig_navigation v1.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module zig_navigation (
  ...
  input  wire [31:0] NavigationConfig_wait_until_in,
  output reg  [31:0] NavigationConfig_wait_until_out,
  input  wire  NavigationConfig_handle_popups_in,
  output reg   NavigationConfig_handle_popups_out,
  input  wire [511:0] NavigationConfig_block_resources_in,
  output reg  [511:0] NavigationConfig_block_resources_out,
  output reg         done
);
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      NavigationConfig_wait_until_out <= 32'd0;
      NavigationConfig_handle_popups_out <= 1'b0;
      NavigationConfig_block_resources_out <= 512'd0;
    end else begin
      case (state)
        ...
        PROCESS: begin
          ...
          NavigationConfig_handle_popups_out <= NavigationConfig_handle_popups_in;
          NavigationConfig_block_resources_out <= NavigationConfig_block_resources_in;
          state <= DONE;
        end
