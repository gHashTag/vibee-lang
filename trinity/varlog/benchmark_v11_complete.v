// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - benchmark_v11_complete v11.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module benchmark_v11_complete (
  ...
  input  wire [255:0] SpeedupProof_claim_in,
  output reg  [255:0] SpeedupProof_claim_out,
  input  wire [63:0] SpeedupProof_theoretical_in,
  output reg  [63:0] SpeedupProof_theoretical_out,
  input  wire [63:0] SpeedupProof_achieved_in,
  output reg  [63:0] SpeedupProof_achieved_out,
  input  wire [63:0] SpeedupProof_efficiency_in,
  output reg  [63:0] SpeedupProof_efficiency_out,
  input  wire [255:0] SpeedupProof_bottleneck_in,
  output reg  [255:0] SpeedupProof_bottleneck_out,
  output reg         done
);
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      SpeedupProof_claim_out <= 256'd0;
      SpeedupProof_theoretical_out <= 64'd0;
      SpeedupProof_achieved_out <= 64'd0;
      SpeedupProof_efficiency_out <= 64'd0;
      SpeedupProof_bottleneck_out <= 256'd0;
    end else begin
      case (state)
        ...
        PROCESS: begin
          ...
          SpeedupProof_claim_out <= SpeedupProof_claim_in;
          SpeedupProof_theoretical_out <= SpeedupProof_theoretical_in;
          SpeedupProof_achieved_out <= SpeedupProof_achieved_in;
          SpeedupProof_efficiency_out <= SpeedupProof_efficiency_in;
          SpeedupProof_bottleneck_out <= SpeedupProof_bottleneck_in;
          state <= DONE;
        end
