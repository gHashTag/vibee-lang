// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - gradient_checkpointing v6726.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module gradient_checkpointing (
  ...
  input  wire [511:0] CheckpointConfig_checkpoint_layers_in,
  output reg  [511:0] CheckpointConfig_checkpoint_layers_out,
  ...
  input  wire [63:0] MemoryProfile_checkpoint_memory_in,
  output reg  [63:0] MemoryProfile_checkpoint_memory_out,
  output reg         done
);
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      CheckpointConfig_checkpoint_layers_out <= 512'd0;
      ...
      MemoryProfile_checkpoint_memory_out <= 64'd0;
    end else begin
      case (state)
        ...
        PROCESS: begin
          ...
          CheckpointConfig_checkpoint_layers_out <= CheckpointConfig_checkpoint_layers_in;
          ...
          MemoryProfile_checkpoint_memory_out <= MemoryProfile_checkpoint_memory_in;
          state <= DONE;
        end
