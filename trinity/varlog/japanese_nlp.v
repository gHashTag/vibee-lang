// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - japanese_nlp v9.9.6
// ═══════════════════════════════════════════════════════════════════════════════
...
module japanese_nlp (
  ...
  input  wire [255:0] Entity_reading_in,
  output reg  [255:0] Entity_reading_out,
    ...
    if (!rst_n) begin
      ...
      case (state)
        ...
        PROCESS: begin
          ...
          Entity_reading_out <= Entity_reading_in;
