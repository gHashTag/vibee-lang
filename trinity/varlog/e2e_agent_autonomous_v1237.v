// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - e2e_agent_autonomous_v1237 v13.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module e2e_agent_autonomous_v1237 (
  input  wire        clk,
  input  wire        rst_n,
  input  wire        enable,
  ...
  input  wire [63:0] E2EMetrics_max_in,
  output reg  [63:0] E2EMetrics_max_out,
  output reg         done
);
    ...
    if (!rst_n) begin
      ...
      case (state)
        ...
        PROCESS: begin
          ...
          E2EMetrics_max_out <= E2EMetrics_max_in;
          state <= DONE;
        end
