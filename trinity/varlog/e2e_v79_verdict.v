// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - e2e_v79_verdict v79.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module e2e_v79_verdict (
  ...
  input  wire [255:0] Verdict_name_in,
  output reg  [255:0] Verdict_name_out,
    ...
    if (!rst_n) begin
      ...
      case (state)
        ...
        PROCESS: begin
          ...
          Verdict_name_out <= Verdict_name_in;
