// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - browser_playwright_storage v1.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module browser_playwright_storage (
  ...
  input  wire [511:0] StorageState_local_storage_in,
  output reg  [511:0] StorageState_local_storage_out,
  input  wire [511:0] StorageState_session_storage_in,
  output reg  [511:0] StorageState_session_storage_out,
  input  wire [255:0] StorageOrigin_origin_in,
  output reg  [255:0] StorageOrigin_origin_out,
  input  wire [511:0] StorageOrigin_local_storage_in,
  output reg  [511:0] StorageOrigin_local_storage_out,
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      StorageState_local_storage_out <= 512'd0;
      StorageState_session_storage_out <= 512'd0;
      StorageOrigin_origin_out <= 256'd0;
      StorageOrigin_local_storage_out <= 512'd0;
      ...
      case (state)
        ...
        PROCESS: begin
          ...
          StorageState_local_storage_out <= StorageState_local_storage_in;
          StorageState_session_storage_out <= StorageState_session_storage_in;
          StorageOrigin_origin_out <= StorageOrigin_origin_in;
          StorageOrigin_local_storage_out <= StorageOrigin_local_storage_in;
