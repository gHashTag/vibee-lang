// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - zig_llm_client v1.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module zig_llm_client (
  ...
  input  wire [31:0] LLMConfig_provider_in,
  output reg  [31:0] LLMConfig_provider_out,
  ...
  input  wire [63:0] LLMResponse_prompt_tokens_in,
  output reg  [63:0] LLMResponse_prompt_tokens_out,
  input  wire [63:0] LLMResponse_completion_tokens_in,
  output reg  [63:0] LLMResponse_completion_tokens_out,
  input  wire [63:0] LLMResponse_total_tokens_in,
  output reg  [63:0] LLMResponse_total_tokens_out,
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      LLMResponse_prompt_tokens_out <= 64'd0;
      LLMResponse_completion_tokens_out <= 64'd0;
      LLMResponse_total_tokens_out <= 64'd0;
      ...
      case (state)
        ...
        PROCESS: begin
          ...
          LLMResponse_prompt_tokens_out <= LLMResponse_prompt_tokens_in;
          LLMResponse_completion_tokens_out <= LLMResponse_completion_tokens_in;
          LLMResponse_total_tokens_out <= LLMResponse_total_tokens_in;
