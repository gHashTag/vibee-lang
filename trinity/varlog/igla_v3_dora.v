// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - igla_v3_dora v3.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module igla_v3_dora (
  ...
  input  wire  DoRAConfig_decompose_magnitude_in,
  output reg   DoRAConfig_decompose_magnitude_out,
  output reg         done
);
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      DoRAConfig_decompose_magnitude_out <= 1'b0;
    end else begin
      case (state)
        ...
        PROCESS: begin
          ...
          DoRAConfig_decompose_magnitude_out <= DoRAConfig_decompose_magnitude_in;
          state <= DONE;
        end
