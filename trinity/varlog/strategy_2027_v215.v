// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - strategy_2027_v215 v215.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module strategy_2027_v215 (
  ...
  input  wire [255:0] Milestone_half_in,
  output reg  [255:0] Milestone_half_out,
    ...
    if (!rst_n) begin
      ...
      case (state)
        ...
        PROCESS: begin
          ...
          Milestone_half_out <= Milestone_half_in;
