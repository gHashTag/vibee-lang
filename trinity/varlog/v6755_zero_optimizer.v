// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - v6755_zero_optimizer v1.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module v6755_zero_optimizer (
  ...
  input  wire  ZeROConfig_offload_params_in,
  output reg   ZeROConfig_offload_params_out,
  output reg         done
);
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      ZeROConfig_offload_params_out <= 1'b0;
    end else begin
      case (state)
        ...
        PROCESS: begin
          ...
          ZeROConfig_offload_params_out <= ZeROConfig_offload_params_in;
          state <= DONE;
        end
