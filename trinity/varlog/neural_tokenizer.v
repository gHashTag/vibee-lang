// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - neural_tokenizer v11.8.5
// ═══════════════════════════════════════════════════════════════════════════════
...
module neural_tokenizer (
  ...
  input  wire [511:0] TokenizerConfig_sacred_tokens_in,
  output reg  [511:0] TokenizerConfig_sacred_tokens_out,
  output reg         done
);
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      TokenizerConfig_sacred_tokens_out <= 512'd0;
    end else begin
      case (state)
        ...
        PROCESS: begin
          ...
          TokenizerConfig_sacred_tokens_out <= TokenizerConfig_sacred_tokens_in;
          state <= DONE;
        end
