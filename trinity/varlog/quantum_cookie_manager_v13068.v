// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - quantum_cookie_manager_v13068 v13068.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module quantum_cookie_manager_v13068 (
  input  wire        clk,
  input  wire        rst_n,
  input  wire        enable,
  ...
  input  wire [63:0] SessionState_cookies_count_in,
  output reg  [63:0] SessionState_cookies_count_out,
  input  wire [255:0] SessionState_domains_in,
  output reg  [255:0] SessionState_domains_out,
  input  wire [63:0] SessionState_total_size_bytes_in,
  output reg  [63:0] SessionState_total_size_bytes_out,
  output reg         done
);
  ...
  always @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      SessionState_cookies_count_out <= 64'd0;
      SessionState_domains_out <= 256'd0;
      SessionState_total_size_bytes_out <= 64'd0;
    end else begin
      case (state)
        ...
        PROCESS: begin
          ...
          SessionState_cookies_count_out <= SessionState_cookies_count_in;
          SessionState_domains_out <= SessionState_domains_in;
          SessionState_total_size_bytes_out <= SessionState_total_size_bytes_in;
          state <= DONE;
        end
