// ═══════════════════════════════════════════════════════════════════════════════
// TRINITY FPGA - codegen_purescript_v1308 v1.0.0
// ═══════════════════════════════════════════════════════════════════════════════
...
module codegen_purescript_v1308 (
  input  wire        clk,
  input  wire        rst_n,
  input  wire        enable,
  ...
  input  wire [255:0] ModuleUnit_code_in,
  output reg  [255:0] ModuleUnit_code_out,
    ...
    if (!rst_n) begin
      ...
      case (state)
        ...
        PROCESS: begin
          ...
          ModuleUnit_code_out <= ModuleUnit_code_in;
