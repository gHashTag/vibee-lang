...
│                                                                             │
│  2. .999 runtime vs Native code                                             │
│     Причина: .999 интерпретируется, native — машинный код.                  │
│     .999 будет МЕДЛЕННЕЕ в runtime, но БЫСТРЕЕ в разработке.                │
│                                                                             │
│  3. SIMD parser на маленьких файлах                                         │
