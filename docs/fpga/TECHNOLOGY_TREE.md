...
```mermaid
graph TD
    Root[СВЯЩЕННАЯ МАТЕМАТИКА] --> Trunk[ВЕКОВОЙ ДУБ]
    Trunk --> Chest[КОВАНЫЙ СУНДУК]
    Chest --> Bra1[БЫСТРЫЙ ЗАЯЦ]
    Chest --> Bra2[ЗОЛОТАЯ УТКА]
    Bra1 --> Lea1[ВОЛШЕБНОЕ ЯЙЦО]
    Bra1 --> Lea2[ЖАР-ПТИЦА]
    Lea1 --> App1[ОСТРАЯ ИГЛА]
    Lea2 --> App2[REBIRTH PROTOCOL]
    App1 --> Singularity((TRINITY SINGULARITY))
    App2 --> Singularity
```
