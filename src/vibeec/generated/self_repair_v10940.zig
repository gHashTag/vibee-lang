// ═══════════════════════════════════════════════════════════════════════════════
// self_repair_v10940 v10940.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
/// 
pub const FaultDetection = struct {
...
/// 
pub const RepairHistory = struct {
    history_id: []const u8,
    repairs: []const u8,
    success_rate: f64,
    mttr_ms: f64,
...
/// 
pub const SystemResilience = struct {
    resilience_score: f64,
    fault_tolerance: f64,
    recovery_time_objective: i64,
    recovery_point_objective: i64,
};
