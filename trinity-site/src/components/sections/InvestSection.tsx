  ...
  return (
    <Section id="invest">
      ...
      <div className="fade" style={{ marginTop: '4rem' }}>
        <a href={inv?.contact?.github} className="btn secondary" target="_blank" rel="noopener">Explore Code on GitHub</a>
      </div>
    </Section>
  )
}
