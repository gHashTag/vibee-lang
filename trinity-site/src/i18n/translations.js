...
export const translations = {
  ...
  ru: {
    ...
    hero: {
      tag: 'Нативное троичное железо для ИИ',
      quote: '"Мы создаём чипы, которые говорят на родном языке ИИ"',
    ...
    problem: {
      ...
      sub: 'Троичные ИИ модели работают на бинарном железе — огромные потери',
    ...
    market: {
      ...
      funnel: [
        { value: '$200B', label: 'TAM — ИИ ускорители' },
        { value: '$80B', label: 'SAM — ИИ инференс' },
    ...
    gtm: {
      ...
      phases: [
        { phase: 'Фаза 1', title: 'Исследовательские лаборатории', desc: 'Университеты, ИИ лаборатории • Бесплатные пилоты • Кейсы' },
        { phase: 'Фаза 2', title: 'ИИ стартапы', desc: 'Экономия на инференсе • FPGA карты • $10K-50K сделки' },
    ...
    team: {
      ...
      hiring: 'Нанимаем: FPGA инженер, ИИ исследователь, развитие бизнеса'
    },
