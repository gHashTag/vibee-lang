...
export const translations = {
  ...
  ru: {
    ...
    techAssets: {
      title: 'Технические <span class="grad">Активы</span>',
      sub: 'Не просто идея. Масштабная, работающая кодовая база.',
      items: [
        { value: '10,244', label: 'Спецификации (.vibee)', desc: 'Формализованная база знаний' },
        { value: '42', label: 'Языка', desc: 'Генерация из одного источника' },
        { value: '100+', label: 'Священных Констант', desc: 'Реализовано в sacred_constants.zig' },
        { value: '88/88', label: 'Тестов Пройдено', desc: 'Ядро VM и модули Trinity' },
        { value: '115 KB', label: 'VM Runtime', desc: 'Легковесная стековая VM' },
        { value: '5.6x', label: 'Быстрее', desc: 'Fibonacci бенчмарк vs Бинарные' }
      ]
    },

    calculatorLogic: {
      title: 'Логика <span class="grad">Калькулятора</span>',
      sub: 'Зачем строить суперкомпьютер, если достаточно калькулятора?',
      comparison: [
        { 
    ...
    benchmarks: {
      title: 'Доказанная <span class="grad">Производительность</span>',
      sub: 'Реальные бенчмарки против лидеров индустрии.',
      metrics: [
        { label: 'Энергия vs H100', value: '-92.8%', desc: '50W ASIC vs 700W GPU' },
        { label: 'Эффективность памяти', value: '+37%', desc: '88GB vs 140GB (70B модель)' },
        { label: 'Плотность инфо', value: '1.585×', desc: 'log₂(3) vs log₂(2)' },
        { label: 'Ускорение VM', value: '5.6×', desc: 'Fibonacci(35) бенчмарк' }
      ],
      comparison: {
        title: 'Скорость Инференса (Токенов/сек)',
        rows: [
          { model: 'Gemma 3 27B (A100)', value: 45, color: '#666' },
          { model: 'Llama 3.3 70B (H100)', value: 25, color: '#666' },
          { model: 'TRINITY (Прогноз)', value: 72, color: 'var(--accent)' }
        ]
      }
    },

    scientificFoundation: {
      title: 'Научный <span class="grad">Фундамент</span>',
      sub: 'Построено на строгой математике и 9 запланированных статьях.',
      items: [
        { 
          value: '33', 
          label: 'Теоремы Доказано', 
          desc: 'Формальные доказательства корректности и эффективности',
          icon: '📐'
        },
        { 
          value: 'PAS', 
          label: 'Методология', 
          desc: 'Predictive Algorithmic Systematics: "Периодическая таблица" алгоритмов',
          icon: '🧬'
        },
        { 
          value: '9', 
          label: 'Статей в Плане', 
          desc: 'Дорожная карта публикаций на arXiv (2026-2027)',
          icon: '📄'
        },
        { 
          value: '100+', 
          label: 'Алгоритмов', 
          desc: 'Каталогизированы по паттернам открытия (D&C, ALG, TEN)',
          icon: '📊'
        }
      ],
      paperTitle: 'Ключевые Области Исследований',
      papers: [
        'Формула Троицы (V = n × 3^k × π^m)',
        'Золотое Сечение и Хаббл (H₀ = 70.74)',
        'Алгоритмическая Периодическая Таблица',
        'Квантовая Суперпозиция как Паттерн'
      ]
    },
