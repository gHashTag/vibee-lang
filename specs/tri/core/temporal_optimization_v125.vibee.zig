// ═══════════════════════════════════════════════════════════════════════════════
// GENERATED FROM: temporal_optimization_v125
...
pub fn temporal_optimization_v125_transform(input: anytype) @TypeOf(input) {
