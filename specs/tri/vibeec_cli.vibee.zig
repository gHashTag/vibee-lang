...
// User Constants
pub const TRINITY = 27;
pub const VERSION_NUMBER = 4.0;
pub const MAX_FILE_SIZE = 1048576;
pub const max_iterations = 1000;
pub const default_iterations = 10;
pub const memory_limit = 1048576;
