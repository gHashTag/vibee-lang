// ═══════════════════════════════════════════════════════════════════════════════
// nsfw_detection v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const BASE_COST_USD: f64 = 0.001;

pub const COST_STARS: f64 = 0;

pub const NSFW_THRESHOLD: f64 = 0;

pub const WARNING_THRESHOLD: f64 = 0;
...
/// Категория NSFW контента
pub const NSFWCategory = struct {
};

/// Запрос на проверку
pub const NSFWDetectionRequest = struct {
    image_url: []const u8,
    check_violence: bool,
    check_explicit: bool,
};
...
/// Результат проверки
pub const NSFWDetectionResponse = struct {
    is_safe: bool,
