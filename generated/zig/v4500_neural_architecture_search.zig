// ═══════════════════════════════════════════════════════════════════════════════
// neural_architecture_search v4.5.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const MAX_LAYERS: f64 = 20;

pub const SEARCH_EPOCHS: f64 = 50;

pub const NUM_CANDIDATES: f64 = 1000;
...
pub const NASConfig = struct {
    ...
    performance_predictor: []const u8,
};
...
test "derive_final_architecture" {
