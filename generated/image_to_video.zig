// ═══════════════════════════════════════════════════════════════════════════════
// image_to_video v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const DEFAULT_DURATION: f64 = 8;

pub const MAX_DURATION: f64 = 30;

pub const DEFAULT_ASPECT_RATIO: f64 = 0;

pub const SERVER_TIMEOUT_MS: f64 = 10000;
...
pub const ImageToVideoRequest = struct {
    image_url: []const u8,
    prompt: []const u8,
...
pub const ImageToVideoResponse = struct {
    success: bool,
    video_url: ?[]const u8,
    job_id: ?[]const u8,
    message: ?[]const u8,
...
test "notify_admin_server_issue" {
