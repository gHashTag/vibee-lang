// ═══════════════════════════════════════════════════════════════════════════════
// face_swap v1.0.0 - Generated from .vibee specification
// ═══════════════════════════════════════════════════════════════════════════════
//
...
pub const PROCESSING_TIMEOUT_MS: f64 = 120000;
...
/// Face swap request
pub const FaceSwapRequest = struct {
...
/// Face swap response
pub const FaceSwapResponse = struct {
    success: bool,
    result_url: ?[]const u8,
    @"error": ?[]const u8,
};
